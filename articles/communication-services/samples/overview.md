...
| [Ejemplo de llamada web](./web-calling-sample.md)                                                        | Tutorial paso a paso de las características de llamada de ACS en la Web. | [Web](https://github.com/Azure-Samples/communication-services-web-calling-tutorial/)                                |
