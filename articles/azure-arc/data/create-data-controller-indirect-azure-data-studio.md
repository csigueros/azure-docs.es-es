...
- Debe [instalar las herramientas cliente](install-client-tools.md), incluido **Azure Data Studio**, las extensiones de Azure Data Studio de nombre **Azure Arc** y la CLI de Azure con la extensión `arcdata`.
