...
> [Referencia a Bing Entity Search API](/rest/api/cognitiveservices/bing-entities-api-v7-reference)

> [!div class="nextstepaction"]
> [Documentación de la API de Mapas de Bing](/bingmaps/)