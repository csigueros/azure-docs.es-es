...
[Documentación de referencia de la versión 3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1/)
...
> [!NOTE]
> El ejemplo siguiente incluye una solicitud para la característica de minería de opiniones de Análisis de sentimiento mediante el parámetro `opinionMining=true`, que proporciona información detallada sobre las valoraciones (adjetivos) relacionadas con los destinos (nombres) del texto.
