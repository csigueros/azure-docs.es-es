...
:::image type="content" source="../media/tutorials/excel/add-credentials.png" alt-text="Adición de credenciales de recursos de lenguaje al flujo" lightbox="../media/tutorials/excel/add-credentials.png":::
