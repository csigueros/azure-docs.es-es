...
Para aprender a usar las nuevas características en vista previa (gb), consulte la [guía paso a paso de OCR](Vision-API-How-to-Topics/call-read-api.md).
