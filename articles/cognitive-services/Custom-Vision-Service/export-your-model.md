...
* **TensorflowJS** para marcos de JavaScript como React, Angular y Vue. Esto se ejecutará tanto en dispositivos **Android** como **iOS**.
* __CoreML__ para __iOS11__.
* __ONNX__ para __Windows ML,__ **Android** e **iOS**.
