...
1. Seleccione **Service Connector (versión preliminar)** en la tabla de contenido de la izquierda. Seleccione **Crear**.
1. Seleccione o escriba los siguientes valores.
    ...
    | **Cuenta de almacenamiento** | Cuenta de almacenamiento | La cuenta de almacenamiento de destino a la que desea conectarse. Si elige otro tipo de servicio, seleccione la instancia de servicio de destino correspondiente. |
