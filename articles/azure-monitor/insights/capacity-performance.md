...
| [Agentes de Linux](../vm/monitor-virtual-machine.md) | No | La solución no recopila información de datos de rendimiento y capacidad de los agentes directos de Linux.|
