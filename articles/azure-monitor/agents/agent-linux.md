...
De nuevo, solo si usa una versión anterior del agente, el ejecutable de python2 debe tener un alias para *python*. A continuación se ofrece un método que puede usar para establecer este alias:
