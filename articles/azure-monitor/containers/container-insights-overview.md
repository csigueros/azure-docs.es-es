...
* Integrarse en [Prometheus](https://prometheus.io/docs/introduction/overview/) para ver las métricas de aplicaciones y de cargas de trabajo que recopila de los nodos y de Kubernetes mediante [consultas](container-insights-log-query.md) para crear alertas personalizadas y paneles y realizar análisis detallado.
