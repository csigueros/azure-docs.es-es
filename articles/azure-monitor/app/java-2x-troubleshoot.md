...
* ¿Ha configurado el agente de Java siguiendo el [agente de configuración de Java](java-2x-agent.md)?
...
Para habilitar la actualización del registro del agente de JVM, actualice el [archivo AI-Agent.xml](java-2x-agent.md):
