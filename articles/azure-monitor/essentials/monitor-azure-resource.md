...
- Costos asociados con el streaming de Event Hubs al reenviar métricas y registros a Azure Event Hubs. Consulte [Precios de Azure Event Hubs](https://azure.microsoft.com/pricing/details/event-hubs/).
