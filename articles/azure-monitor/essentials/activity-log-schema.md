...
| [Seguridad](#security-category) | Contiene el registro de las alertas generadas por Microsoft Defender para la nube. Ejemplo de un evento de seguridad: _Se ha ejecutado un archivo de extensión doble_. |
