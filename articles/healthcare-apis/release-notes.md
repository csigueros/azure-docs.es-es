...
|------------------------ | -------------------------------: |
|Regions |Sur de Brasil y Centro de Canadá |
...
|Proporciona una excepción mejor si hay una expresión no válida en un parámetro de búsqueda. |[#2157](https://github.com/microsoft/fhir-server/pull/2157) |
