---
title: Funcionalidades de la API rest de FHIR para Azure API for FHIR
description: En este artículo se describen las interacciones y funcionalidades de RESTful para Azure API for FHIR.
author: stevewohl
...
En Revisión, hay una operación de prueba que le permite validar que una condición es verdadera antes de realizar la revisión. Por ejemplo, si quisiera establecer un paciente, solo si aún no se marcaban como desaparecidos, podría usar el ejemplo siguiente: 
...
En este artículo, ha aprendido sobre algunas de las funcionalidades rest de Azure API for FHIR. A continuación, puede obtener más información sobre los aspectos clave de la búsqueda de recursos en FHIR. 

>[!div class="nextstepaction"]
>[Información general de la búsqueda en Azure API for FHIR](overview-of-search.md)
