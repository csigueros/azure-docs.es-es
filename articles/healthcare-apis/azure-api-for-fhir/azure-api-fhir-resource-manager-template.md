...
4. Escriba un nuevo valor en **Nombre de servicio** y elija el valor de **Ubicación** para Azure API for FHIR. La ubicación puede ser la misma región de los recursos u otra.
   ...
   [![Implemente Azure API for FHIR mediante la plantilla de ARM en el Azure Portal. ](media/fhir-resource-manager-template/deploy-azure-api-fhir.png) ](media/fhir-resource-manager-template/deploy-azure-api-fhir.png#lightbox)
