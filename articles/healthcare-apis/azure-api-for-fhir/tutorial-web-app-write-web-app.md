---
title: 'Tutorial de aplicación web: Escribir aplicación web - Azure API for FHIR'
...
ms.locfileid: "121787030"
---
# <a name="write-azure-web-application-to-read-fhir-data-in-azure-api-for-fhir"></a>Escritura de una aplicación web de Azure para leer datos de FHIR en Azure API for FHIR
