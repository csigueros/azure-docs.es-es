...
2. Escriba el nombre **del centro de eventos**.
   ...
   Para obtener información Azure Event Hubs, consulte [Inicio rápido: Creación de un centro de eventos mediante Azure Portal](../../event-hubs/event-hubs-create.md#create-an-event-hubs-namespace).
...
4. Escriba el nombre del espacio **de nombres completo**.
    ...
    Para obtener más información sobre Event Hubs espacios de nombres, vea [Espacio](../../event-hubs/event-hubs-features.md?WT.mc_id=Portal-Microsoft_Healthcare_APIs#namespace) de nombres en el documento Características y terminología Azure Event Hubs.
...
4. En **Asignación de destino**, escriba el código JSON dentro del editor de código.
   ...
   Para obtener información sobre la herramienta mapeador, consulte Herramienta mapeador de datos del conector [de IoMT.](https://github.com/microsoft/iomt-fhir/tree/master/tools/data-mapper)
...
Las etiquetas son pares de nombre y valor que se usan para categorizar recursos. Para más información sobre las etiquetas, consulte [Uso de etiquetas para organizar los recursos de Azure y la jerarquía de administración.](../../azure-resource-manager/management/tag-resources.md)
...
1. En la **lista Grupo de recursos de Azure,** seleccione el nombre del espacio de nombres Event Hubs **.**
...
6. Seleccione **Guardar**.
   ...
   ![Captura de pantalla del mensaje de asignación de roles agregados del servicio FHIR.](media/fhir-service-added-role-assignment.png#lightbox)

   Para más información sobre cómo asignar roles al servicio FHIR, consulte Configuración de RbAC de [Azure para el servicio FHIR.](../fhir/configure-azure-rbac-for-fhir.md)
