...
* [Event Hubs espacio de nombres y centro de eventos implementados en el Azure Portal](../../event-hubs/event-hubs-create.md)
* [Área de trabajo implementada en las API de Azure Healthcare](../workspace-overview.md)  
...
1. Inicie sesión en la [Azure Portal](https://portal.azure.com)y, a continuación, escriba el nombre del recurso del área de trabajo de Healthcare API en el **campo Barra** de búsqueda.
...
2. Seleccione la **hoja Conectores de IoT.**
...
4. A continuación, seleccione **Crear**.
   ...
   El conector de IoT recién implementado se mostrará dentro del grupo de recursos de Azure.
...
4. Seleccione el **rol y,** a continuación, **seleccione Azure Event Hubs receptor de datos**.
   ...
   ![Captura de pantalla de la adición de campos obligatorios de asignación de roles.](media/event-hub-add-role-assignment-fields.png#lightbox)
