...
La forma en que el servicio FHIR de las API de Azure Healthcare (que aquí se denomina el servicio FHIR) valida que el token de acceso dependerá de la implementación y configuración. En este artículo se le guía a lo largo de los pasos de validación, lo que puede ser útil para solucionar problemas de acceso.
