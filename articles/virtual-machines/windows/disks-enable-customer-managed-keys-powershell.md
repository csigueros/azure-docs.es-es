...
## <a name="set-up-an-azure-key-vault-and-diskencryptionset-optionally-with-automatic-key-rotation"></a>Configuración de Azure Key Vault and DiskEncryptionSet opcionalmente con rotación de claves automática
