...
Para permitir la comunicación con la máquina virtual en la red virtual, necesitará una [dirección IP pública](../../virtual-network/ip-services/public-ip-addresses.md) y una interfaz de red.
