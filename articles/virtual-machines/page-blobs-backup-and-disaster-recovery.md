---
title: Copia de seguridad y recuperación ante desastres de discos no administrados en máquinas virtuales de Azure
description: En este artículo se explica cómo planear la copia de seguridad y recuperación ante desastres de discos y máquinas virtuales IaaS en Azure. En este documento se tratan los discos no administrados.
author: roygara
ms.service: storage
ms.topic: conceptual
ms.date: 07/19/2017
...
ms.locfileid: "123114289"
---
# <a name="backup-and-disaster-recovery-for-azure-unmanaged-disks"></a>Copia de seguridad y recuperación ante desastres de discos no administrados de Azure
...
En este artículo se explica cómo planear la copia de seguridad y recuperación ante desastres (DR) de discos y máquinas virtuales (VM) IaaS en Azure. En este documento se tratan los discos no administrados o los blobs en páginas.
