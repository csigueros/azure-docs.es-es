...
4. **[A]** Configurar `autofs` para montar los sistemas de archivos /sapmnt/SID y /usr/sap/SID/SYS para los sistemas SAP adicionales que va a implementar en el clúster. En este ejemplo, **NW2** y **NW3**.  
   ...
   * Si usa el servidor de archivos NFS, siga las instrucciones de la página [Alta disponibilidad de máquinas virtuales de Azure para SAP NetWeaver en SLES](./high-availability-guide-suse.md#prepare-for-sap-netweaver-installation).
   * Si usa Azure NetApp Files, siga las instrucciones de la página [Alta disponibilidad de máquinas virtuales de Azure para SAP NW en SLES con Azure NetApp Files](./high-availability-guide-suse-netapp-files.md#prepare-for-sap-netweaver-installation).
