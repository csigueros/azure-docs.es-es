...
Para la máquina virtual de Microsoft Windows Server, consulte la [documentación de Microsoft Azure](/azure/virtual-machines/windows/overview) sobre cómo crear una máquina virtual de Windows Server en Azure.
...
* Microsoft Docs para [Red Hat en Azure](https://aka.ms/rhel-docs)
* [Imágenes Gold de tipo BYOS de RHEL en Azure](/azure/virtual-machines/workloads/redhat/byos)
...
* Ejecución de JBoss EAP en [Azure App Service](https://aka.ms/jboss-app-service-overview)
