...
Cree la máquina virtual con [az vm create](/cli/azure/vm#az_vm_create) mediante el parámetro --specialized para indicar que la imagen es una imagen especializada. 
