...
Para crear una instancia de Network Watcher, consulte esta [plantilla de inicio rápido](https://azure.microsoft.com/resources/templates/networkwatcher-create/).
