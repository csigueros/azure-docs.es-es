...
Una vez configurado EAB Implementation, podrá aplicar el control de sesión, que protege a la organización de la filtración y la infiltración de información en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-any-app).
