---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con MyVR | Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-myvr"></a>Configuración y prueba del inicio de sesión único de Azure AD para MyVR

Configure y pruebe el inicio de sesión único de Azure AD con MyVR mediante un usuario de prueba llamado **B.Simon**. Para que el SSO funcione, es necesario establecer una relación de vinculación entre un usuario de Azure AD y el usuario relacionado de MyVR.
...
1. **[Configuración del inicio de sesión único en MyVR](#configure-myvr-sso)** : para configurar los valores de inicio de sesión único en la aplicación.
    1. **[Creación de un usuario de prueba en MyVR](#create-myvr-test-user)**: para tener un homólogo de B.Simon en MyVR vinculado a la representación del usuario en Azure AD.
...
1. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL: `https://ess.virtualroster.net/ess/login.aspx`
...
1. Además de lo anterior, la aplicación MyVR espera que se devuelvan algunos atributos más, que se muestran a continuación, en la respuesta de SAML. Estos atributos también se rellenan previamente, pero puede revisarlos según sus requisitos.
...
En esta sección va a permitir que B.Simon acceda a MyVR mediante el inicio de sesión único de Azure.
...
Al hacer clic en el icono de MyVR en el panel de acceso, debería iniciar sesión automáticamente en la versión de MyVR para la que configurara el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
...
- [Prueba de MyVR con Azure AD](https://aad.portal.azure.com/)