...
* Harness admite el [aprovisionamiento automatizado de usuarios](harness-provisioning-tutorial.md).
...
Harness también admite el aprovisionamiento automático de usuarios. [Aquí](./harness-provisioning-tutorial.md) puede encontrar más detalles sobre cómo configurar el aprovisionamiento automático de usuarios.
...
Una vez configurado Harness, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
