...
## <a name="add-oc-tanner---appreciatehub-from-the-gallery"></a>Agregue O.C. Tanner - AppreciateHub desde la galería
...
## <a name="configure-and-test-azure-ad-sso-for-oc-tanner---appreciatehub"></a>Configuración y prueba del inicio de sesión único de Azure AD para O.C. C. Tanner - AppreciateHub
...
Para configurar y probar el inicio de sesión único de Azure AD con O.C. Tanner - AppreciateHub, realice los pasos siguientes:
...
1. **[Configuración de O.C. Tanner - AppreciateHub: inicio de sesión único](#configure-oc-tanner---appreciatehub-sso)** , para configurar los valores de inicio de sesión único en la aplicación.
    1. **[Creación de un usuario de prueba de O.C. Tanner - AppreciateHub](#create-oc-tanner---appreciatehub-test-user)** , para tener un homólogo de B.Simon en O.C. Tanner - AppreciateHub que esté vinculado a la representación del usuario en Azure AD.
...
1. En Azure Portal, en la página de integración de la aplicación **O.C Tanner - AppreciateHub**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Una vez configurado O.C. Tanner - AppreciateHub, puede aplicar el control de sesión, que protegen la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-any-app).
