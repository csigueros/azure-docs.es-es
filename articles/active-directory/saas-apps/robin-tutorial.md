...
## <a name="configure-and-test-azure-ad-sso-for-robin"></a>Configuración y prueba del inicio de sesión único de Azure AD para Robin
...
Para configurar y probar el inicio de sesión único de Azure AD con Robin, lleve a cabo los siguientes pasos:
...
1. En Azure Portal, en la página de integración de la aplicación **Robin**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL: `https://dashboard.robinpowered.com/`

1. La aplicación Robin espera las aserciones de SAML en un formato específico, que requiere que se agreguen asignaciones de atributos personalizados a la configuración de los atributos del token de SAML. La siguiente captura de muestra la lista de atributos predeterminados.
...
1. En la sección **Configurar Robin**, copie las direcciones URL adecuadas según sus necesidades.
...
* Haga clic en **Probar esta aplicación** en Azure Portal. Esta acción le redirigirá a la dirección URL de inicio de sesión de Robin, donde puede comenzar el flujo de inicio de sesión.  

* Vaya directamente a la dirección URL de inicio de sesión de Robin e inicie el flujo de inicio de sesión desde allí.
...
Una vez configurado Robin, puede aplicar el control de sesión, que protege frente a la filtración e infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).
