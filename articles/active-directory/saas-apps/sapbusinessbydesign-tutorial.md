...
* Una vez configurado SAP Business ByDesign, puede aplicar controles de sesión para proteger en tiempo real los datos confidenciales de la organización e impedir que se filtren dentro y fuera de esta. Los controles de sesión proceden del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-any-app).
