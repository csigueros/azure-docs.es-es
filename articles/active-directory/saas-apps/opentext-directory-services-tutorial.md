...
* OpenText Directory Services admite el [aprovisionamiento automatizado de usuarios](open-text-directory-services-provisioning-tutorial.md).
...
> [!NOTE]
> OpenText Directory Services también admite el aprovisionamiento automático de usuarios. [Aquí](./open-text-directory-services-provisioning-tutorial.md) puede encontrar más detalles sobre cómo configurarlo.
