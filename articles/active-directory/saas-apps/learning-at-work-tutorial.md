...
Una vez que haya configurado Learning at Work, podrá aplicar el control de sesión, que protege la información confidencial de la información en tiempo real de posibles filtraciones. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-any-app).
