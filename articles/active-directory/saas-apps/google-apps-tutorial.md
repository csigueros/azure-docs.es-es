...
4. Realice los cambios de configuración siguientes:
    ...
    ![Configurar el inicio de sesión único.](./media/google-apps-tutorial/configuration.png)
...
Una vez configurado Google Cloud (G Suite) Connector, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
