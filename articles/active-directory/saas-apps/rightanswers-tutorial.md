...
* Suscripción habilitada para el inicio de sesión único en RightAnswers

## <a name="scenario-description"></a>Descripción del escenario

En este tutorial, puede configurar y probar el inicio de sesión único de Azure AD en un entorno de prueba.

* RightAnswers admite inicio de sesión único iniciado por **SP**.
...
4. En el cuadro de búsqueda, escriba **RightAnswers**, seleccione **RightAnswers** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![RightAnswers en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de RightAnswers.
...
2. **[Configuración del inicio de sesión único de RightAnswers](#configure-rightanswers-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de RightAnswers](#create-rightanswers-test-user)**: el objetivo es tener un homólogo de Britta Simon en RightAnswers que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **RightAnswers**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con la dirección URL y el identificador reales de inicio de sesión. Póngase en contacto con el [equipo de atención al cliente de RightAnswers](https://uplandsoftware.com/rightanswers/contact/) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up RightAnswers** (Configurar RightAnswers), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-rightanswers-single-sign-on"></a>Configuración de inicio de sesión único de RightAnswers

Para configurar el inicio de sesión único en **RightAnswers**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de RightAnswers](https://uplandsoftware.com/rightanswers/contact/). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.

> [!NOTE]
> El equipo de soporte técnico de RightAnswers es el que tiene que realizar la configuración real de SSO. Cuando SSO se haya habilitado en su suscripción recibirá una notificación.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **RightAnswers**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **RightAnswers**.

    ![Vínculo a RightAnswers en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-rightanswers-test-user"></a>Creación de un usuario de prueba de RightAnswers
...
Al hacer clic en el icono de RightAnswers en el panel de acceso, debería iniciar sesión automáticamente en la versión de RightAnswers para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
