...
Para configurar Zip para admitir el aprovisionamiento con Azure AD: póngase en contacto con el equipo de soporte técnico de Zip en [`support@ziphq.com`](mailto:support@ziphq.com). Proporcionarán la dirección URL del inquilino y el token secreto necesarios para configurar el aprovisionamiento automático de usuarios en Zip, como se mencionó en el paso 5.
