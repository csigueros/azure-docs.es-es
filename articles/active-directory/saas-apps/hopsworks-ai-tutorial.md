...
* Hopsworks.ai inicio de sesión único iniciado por **SP.**
...
## <a name="configure-hopsworksai-sso"></a>Configuración del inicio de sesión único en Hopsworks.ai
...
Una vez que haya configurado Hopsworks.ai, podrá aplicar el control de sesión, que protege la información confidencial de la organización en tiempo real de posibles filtraciones. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
