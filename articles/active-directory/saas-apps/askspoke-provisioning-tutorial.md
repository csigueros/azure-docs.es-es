...
> -  [Inicio de sesión único](./askspoke-tutorial.md) para askSpoke (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y askSpoke](../app-provisioning/customize-application-attributes.md).
