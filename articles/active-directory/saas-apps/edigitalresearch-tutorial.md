...
* eDigitalResearch admite SSO iniciado por **IDP**
...
4. En el cuadro de búsqueda, escriba **eDigitalResearch**, seleccione **eDigitalResearch** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![eDigitalResearch en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de eDigitalResearch.
...
2. **[Configuración del inicio de sesión único de eDigitalResearch](#configure-edigitalresearch-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de eDigitalResearch](#create-edigitalresearch-test-user)** : para tener un homólogo de Britta Simon en eDigitalResearch que esté vinculado a la representación de ella en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **eDigitalResearch**, seleccione **Inicio de sesión único**.
...
4. En la página **Configurar inicio de sesión único con SAML** realice los siguientes pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de eDigitalResearch](common/idp-intiated.png)

    a. En el cuadro de texto **Identificador**, escriba una dirección URL con el patrón siguiente: `https://<company-name>.edigitalresearch.com`
...
### <a name="configure-edigitalresearch-single-sign-on"></a>Configuración del inicio de sesión único de eDigitalResearch

Para configurar el inicio de sesión único en **eDigitalResearch**, es preciso enviar el **certificado (Base64)** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de eDigitalResearch](https://www.maruedr.com/contact). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **eDigitalResearch**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **eDigitalResearch**.

    ![Vínculo a eDigitalResearch en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-edigitalresearch-test-user"></a>Creación de un usuario de prueba de eDigitalResearch

En esta sección, creará una usuaria llamada Britta Simon en eDigitalResearch. Trabaje con el [equipo de soporte técnico de eDigitalResearch](https://www.maruedr.com/contact) para agregar los usuarios a la plataforma de eDigitalResearch. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
...
Al hacer clic en el icono de eDigitalResearch en el panel de acceso, debería iniciar sesión automáticamente en la versión de eDigitalResearch para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
