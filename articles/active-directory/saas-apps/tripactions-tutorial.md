---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con TripActions | Microsoft Docs'
...
ms.locfileid: "124789453"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-tripactions"></a>Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con TripActions
...
## <a name="adding-tripactions-from-the-gallery"></a>Incorporación de TripActions desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-tripactions"></a>Configuración y prueba del inicio de sesión único de Azure AD para TripActions
...
Para configurar y probar el inicio de sesión único de Azure AD con TripActions, complete los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único en TripActions](#configure-tripactions-sso)**, para configurar los valores de Inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de TripActions](#create-tripactions-test-user)**, para tener un homólogo de B.Simon en TripActions vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **TripActions**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de TripActions en el Panel de acceso y debería iniciar sesión automáticamente en la versión de TripActions para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
...
- [Pruebe TripActions con Azure AD](https://aad.portal.azure.com/)