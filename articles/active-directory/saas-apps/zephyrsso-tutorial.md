...
* Suscripción de ZephyrSSO con el inicio de sesión único habilitado

## <a name="scenario-description"></a>Descripción del escenario

En este tutorial, puede configurar y probar el inicio de sesión único de Azure AD en un entorno de prueba.

* ZephyrSSO admite el inicio de sesión único iniciado por **IDP**.
...
4. En el cuadro de búsqueda, escriba **ZephyrSSO**, seleccione **ZephyrSSO** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![ZephyrSSO en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de ZephyrSSO.
...
2. **[Configuración del inicio de sesión único de ZephyrSSO](#configure-zephyrsso-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de ZephyrSSO](#create-zephyrsso-test-user)**: para tener un homólogo de Britta Simon en ZephyrSSO que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **ZephyrSSO**, seleccione **Inicio de sesión único**.
...
4. En la página **Configurar inicio de sesión único con SAML** realice los siguientes pasos:
    ...
    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con el identificador y la URL de respuesta reales. Póngase en contacto con el [equipo de soporte al cliente de ZephyrSSO](https://support.getzephyr.com/) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up ZephyrSSO** (Configurar ZephyrSSO), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-zephyrsso-single-sign-on"></a>Configuración del inicio de sesión único de ZephyrSSO

Para configurar el inicio de sesión único en **ZephyrSSO**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de ZephyrSSO](https://support.getzephyr.com/). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **ZephyrSSO**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **ZephyrSSO**.

    ![Vínculo a ZephyrSSO en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-zephyrsso-test-user"></a>Creación de un usuario de prueba de ZephyrSSO
...
Al hacer clic en el icono de ZephyrSSO en el panel de acceso, debería iniciar sesión automáticamente en la versión de ZephyrSSO para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
