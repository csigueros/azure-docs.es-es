...
Una vez que haya configurado ContractWorks, puede aplicar el control de sesión, que protege su organización en tiempo real frente a la exfiltración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad).