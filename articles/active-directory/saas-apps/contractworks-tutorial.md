...
ms.locfileid: "132296406"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-contractworks"></a>Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con ContractWorks
...
## <a name="add-contractworks-from-the-gallery"></a>Incorporación de ContractWorks desde la galería
...
## <a name="configure-and-test-azure-ad-sso-for-contractworks"></a>Configuración y prueba del inicio de sesión único de Azure AD para ContractWorks
...
Para configurar y probar el inicio de sesión único de Azure AD con ContractWorks, lleve a cabo los siguientes pasos:
...
1. En Azure Portal, en la página de integración de aplicaciones de **ContractWorks**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la página **Configurar el inicio de sesión único con SAML**, escriba los valores de los siguientes campos:
    ...
    En el cuadro de texto **Identificador**, escriba la dirección URL `https://login.securedocs.com/saml/metadata`
...
* Haga clic en **Probar esta aplicación** en Azure Portal. Esta acción le redirigirá a la dirección URL de inicio de sesión de ContractWorks, donde puede comenzar el flujo de inicio de sesión.  

* Vaya directamente a la dirección URL de inicio de sesión de ContractWorks y comience el flujo de inicio de sesión desde allí.

#### <a name="idp-initiated"></a>Iniciado por IDP:

* Haga clic en **Probar esta aplicación** en Azure Portal; debería iniciar sesión automáticamente en la instancia de ContractWorks para la que ha configurado el inicio de sesión único. 

También puede usar Aplicaciones de Microsoft para probar la aplicación en cualquier modo. Al hacer clic en el icono de ContractWorks en Mis aplicaciones, si se ha configurado en modo SP, se le redirigirá a la página de inicio de sesión de la aplicación para comenzar el flujo de inicio de sesión; y si se ha configurado en modo IDP, se debería iniciar sesión automáticamente en la instancia de ContractWorks para la que ha configurado el inicio de sesión único. Para más información acerca de Aplicaciones, consulte [Inicio de sesión e inicio de aplicaciones desde el portal Aplicaciones](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Pasos siguientes

Una vez que haya configurado ContractWorks, puede aplicar el control de sesión, que protege su organización en tiempo real frente a la exfiltración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
