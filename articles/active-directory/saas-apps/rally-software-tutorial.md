...
## <a name="add-rally-software-from-the-gallery"></a>Adición de Rally Software desde la galería
...
## <a name="configure-rally-software-sso"></a>Configuración del inicio de sesión único de Rally Software
...
Una vez que haya configurado Rally Software, podrá aplicar el control de sesión, que protege a la organización en tiempo real frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
