---
title: 'Tutorial: Integración del inicio de sesión único de Azure AD con Helper Helper'
...
* Helper Helper admite el inicio de sesión único iniciado por **SP e IDP**, así como el aprovisionamiento de usuarios **Just In Time**.

## <a name="add-helper-helper-from-the-gallery"></a>Incorporación de Helper Helper desde la galería
...
## <a name="configure-and-test-azure-ad-sso-for-helper-helper"></a>Configuración y prueba del inicio de sesión único de Azure AD para Helper Helper
...
1. En Azure Portal, en la página de integración de aplicaciones de **Helper Helper**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la sección **Configuración básica de SAML**, si tiene el **archivo de metadatos del proveedor de servicios** y desea realizar la configuración en el modo iniciado por **IDP**, realice los pasos siguientes:
    ...
    > [!Note]
    > Si los valores **Identificador** y **Dirección URL de respuesta** no se rellenan de forma automática, hágalo manualmente según sus necesidades.
...
## <a name="configure-helper-helper-sso"></a>Configuración del inicio de sesión único de Helper Helper
...
* Haga clic en **Probar esta aplicación** en Azure Portal. Esta acción le redirigirá a la URL de inicio de sesión de Helper Helper, desde donde podrá comenzar el flujo de inicio de sesión.  

* Vaya directamente a la dirección URL de inicio de sesión de Helper Helper e inicie el flujo de inicio de sesión desde allí.

#### <a name="idp-initiated"></a>Iniciado por IDP:

* Haga clic en **Probar esta aplicación** en Azure Portal; se debería iniciar sesión automáticamente en la instancia de Helper Helper para la que haya configurado el inicio de sesión único. 

También puede usar Aplicaciones de Microsoft para probar la aplicación en cualquier modo. Al hacer clic en el icono de Helper Helper en Aplicaciones, si se ha configurado en modo SP, se le redirigirá a la página de inicio de sesión de la aplicación para comenzar el flujo de inicio de sesión; y si se ha configurado en modo IDP, se debería iniciar sesión automáticamente en la instancia de Helper Helper para la que ha configurado el inicio de sesión único. Para más información acerca de Aplicaciones, consulte [Inicio de sesión e inicio de aplicaciones desde el portal Aplicaciones](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Pasos siguientes

Una vez que haya configurado Helper Helper, podrá aplicar el control de sesión, que protege a la organización en tiempo real frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad).
