...
## <a name="add-netop-portal-from-the-gallery"></a>Incorporación de Netop Portal desde la galería
...
## <a name="configure-and-test-azure-ad-sso-for-netop-portal"></a>Configuración y prueba del inicio de sesión único de Azure AD para Netop Portal
...
Para configurar y probar el inicio de sesión único de Azure AD con Netop Portal, realice los siguientes pasos:
...
1. En Azure Portal, en la página de integración de aplicaciones de **Netop Portal**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
* Haga clic en Probar esta aplicación en Azure Portal; debería iniciar sesión automáticamente en la instancia de Netop Portal para la que ha configurado el inicio de sesión único.

* Puede usar Mis aplicaciones de Microsoft. Al hacer clic en el icono de Netop Portal en Aplicaciones, debería iniciar sesión automáticamente en la aplicación Netop Portal para la que ha configurado el inicio de sesión único. Para más información acerca de Aplicaciones, consulte [Inicio de sesión e inicio de aplicaciones desde el portal Aplicaciones](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Pasos siguientes

Una vez configurado Netop Portal, puede aplicar el control de sesión, que protege a su organización, en tiempo real, frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
