...
## <a name="add-upwork-enterprise-from-the-gallery"></a>Adición de Upwork Enterprise desde la galería
...
## <a name="configure-and-test-azure-ad-sso-for-upwork-enterprise"></a>Configuración y prueba del inicio de sesión único de Azure AD para Zero Upwork Enterprise
...
Para configurar y probar el inicio de sesión único de Azure AD con Zero Upwork Enterprise, siga estos pasos:
...
1. **[Configuración del inicio de sesión único en Upwork Enterprise](#configure-upwork-enterprise-sso)**, para configurar los valores de inicio de sesión único en la aplicación.
    1. **[Creación de un usuario de prueba de Upwork Enterprise](#create-upwork-enterprise-test-user)**, para tener un homólogo de B.Simon en Upwork Enterprise que esté vinculado a la representación de este usuario en Azure AD.
...
1. En Azure Portal, en la página de integración de la aplicación **Upwork Enterprise**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL: `https://www.upwork.com/ab/account-security/login`
...
* Haga clic en **Probar esta aplicación** en Azure Portal. Esto le redirigirá a la dirección URL de inicio de sesión de Upwork Enterprise, donde puede iniciar el flujo de inicio de sesión.  

* Vaya directamente a la dirección URL de inicio de sesión de Upwork Enterprise e inicie el flujo de inicio de sesión desde allí.

#### <a name="idp-initiated"></a>Iniciado por IDP:

* Haga clic en **Probar esta aplicación** en Azure Portal; debería iniciar sesión automáticamente en la instancia de Upwork Enterprise para la que ha configurado el inicio de sesión único. 

También puede usar Aplicaciones de Microsoft para probar la aplicación en cualquier modo. Al hacer clic en el icono de Upwork Enterprise en Mis aplicaciones, si ha realizado la configuración en modo SP, se le redirigirá a la página de inicio de sesión de la aplicación para comenzar el flujo de inicio de sesión. Si ha realizado la configuración en modo IDP, debería iniciar sesión automáticamente en la instancia de Upwork Enterprise para la que ha configurado el inicio de sesión único. Para más información acerca de Aplicaciones, consulte [Inicio de sesión e inicio de aplicaciones desde el portal Aplicaciones](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Pasos siguientes

Una vez que haya configurado Upwork Enterprise, podrá aplicar el control de sesión, que protege a la organización en tiempo real frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
