...
3. Determine qué datos quiere [asignar entre Azure AD y Global Relay Identity Sync](../app-provisioning/customize-application-attributes.md). 
...
Agregue Global Relay Identity Sync desde la galería de aplicaciones de Azure AD para empezar a administrar el aprovisionamiento en Global Relay Identity Sync. Puede encontrar más información sobre cómo agregar una aplicación desde la galería [aquí](../manage-apps/add-application-portal.md). 
