...
* Hootsuite admite el [aprovisionamiento automático de usuarios](hootsuite-provisioning-tutorial.md)
...
Hootsuite también admite el aprovisionamiento automático de usuarios. [Aquí](./hootsuite-provisioning-tutorial.md) puede encontrar más detalles sobre cómo configurar el aprovisionamiento automático de usuarios.
...
Una vez que se ha configurado Hootsuite, puede aplicar el control de sesión, que protege a la organización en tiempo real frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-aad).
