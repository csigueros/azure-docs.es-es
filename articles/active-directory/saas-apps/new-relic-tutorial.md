...
* New Relic admite el [aprovisionamiento y desaprovisionamiento **automático** de usuarios](new-relic-by-organization-provisioning-tutorial.md) (recomendado).
...
Una vez haya configurado New Relic by Account, puede aplicar el control de sesión, que protege a la organización en tiempo real frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Defender para aplicaciones en la nube](/cloud-app-security/proxy-deployment-any-app).
