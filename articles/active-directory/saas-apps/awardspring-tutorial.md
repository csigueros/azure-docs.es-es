---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con AwardSpring | Microsoft Docs'
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-awardspring"></a>Configuración y prueba del inicio de sesión único de Azure AD para AwardSpring
...
Para configurar y probar el inicio de sesión único de Azure AD con AwardSpring, complete los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único de AwardSpring](#configure-awardspring-sso)**, para configurar los valores de Inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de AwardSpring](#create-awardspring-test-user)**, para tener un homólogo de B.Simon en AwardSpring vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **AwardSpring**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
- [Pruebe AwardSpring con Azure AD](https://aad.portal.azure.com/)