...
| **Sistemas operativos** | Windows 10 y versiones posteriores, iOS, Android y macOS |
| **Aprovisionamiento** | Windows 10 y versiones posteriores: configuración |
...
El registro en Azure AD se puede realizar al acceder por primera vez a una aplicación de trabajo o si se usa manualmente el menú Configuración de Windows 10 o Windows 11. 
