---
title: Exportación de la configuración de aprovisionamiento de aplicaciones y reversión a un estado correcto conocido para la recuperación ante desastres en Azure Active Directory
description: Obtenga información sobre cómo exportar la configuración de aprovisionamiento de aplicaciones y reversión a un estado correcto conocido para la recuperación ante desastres en Azure Active Directory.
