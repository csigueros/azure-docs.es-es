---
title: Averiguar cuándo un usuario específico podrá acceder a una aplicación en el aprovisionamiento de aplicaciones de Azure Active Directory
description: Cómo averiguar cuándo un usuario sumamente importante puede acceder a una aplicación que se ha configurado para el aprovisionamiento de usuarios con Azure Active Directory
