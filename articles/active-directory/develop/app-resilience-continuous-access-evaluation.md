...
Cuando se cumplen estas condiciones, la aplicación puede extraer y descodificar el desafío de notificaciones mediante la clase `WwwAuthenticateParameters` de MSAL.NET.
