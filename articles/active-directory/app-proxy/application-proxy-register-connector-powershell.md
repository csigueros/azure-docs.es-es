---
title: Instalación silenciosa del conector de Azure Active Directory Application Proxy
description: Explica cómo realizar una instalación desatendida de Azure Active Directory Application Proxy Connector para proporcionar acceso remoto seguro a las aplicaciones en el entorno local.
...
ms.locfileid: "129988931"
---
# <a name="create-an-unattended-installation-script-for-the-azure-active-directory-application-proxy-connector"></a>Creación de un script de instalación desatendida para el conector de Azure Active Directory Application Proxy
