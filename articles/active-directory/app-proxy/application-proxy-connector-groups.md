---
title: 'Publicación de aplicaciones en redes independientes a través de grupos de conectores: Azure Active Directory'
description: En este documento se explica cómo crear y administrar grupos de conectores en Azure Active Directory Application Proxy.
...
Los clientes usan Application Proxy de Azure AD en cada vez más escenarios y aplicaciones. Por este motivo, hemos habilitado más topologías para que sea más flexible. Puede crear grupos de conectores del proxy de aplicación a fin de asignar conectores específicos para atender a aplicaciones concretas. Esta funcionalidad proporciona un mayor control y formas de optimizar la implementación del proxy de aplicación.
...
[Descripción de los conectores de Azure AD Application Proxy](application-proxy-connectors.md)
[Habilitación del inicio de sesión único](../manage-apps/what-is-single-sign-on.md)
