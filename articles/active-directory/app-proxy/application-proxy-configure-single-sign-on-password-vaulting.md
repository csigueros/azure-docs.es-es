---
title: Inicio de sesión único en aplicaciones con Application Proxy de Azure Active Directory
description: Active el inicio de sesión único para sus aplicaciones locales publicadas, usando Application Proxy de Azure Active Directory en Azure Portal.
...
- Obtenga información sobre otras maneras de implementar el [inicio de sesión único](../manage-apps/what-is-single-sign-on.md)
