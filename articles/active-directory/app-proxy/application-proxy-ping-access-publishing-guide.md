---
title: Autenticación basada en encabezados con PingAccess para Azure Active Directory Application Proxy
...
1. Rellene los campos requeridos con la información de la aplicación nueva. Utilice las instrucciones siguientes para configurarla.
   ...
   > [!NOTE]
   > Para obtener un tutorial más detallado de este paso, vea [ Adición de una aplicación local a Azure AD](../app-proxy/application-proxy-add-on-premises-application.md#add-an-on-premises-app-to-azure-ad).
