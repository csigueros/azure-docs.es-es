...
>[!NOTE] 
> Este artículo contiene información de referencia de las versiones sobre todas las versiones archivadas de Azure AD, 1.5.42.0 y anteriores.  Para las versiones actuales, consulte [Azure AD Connect: Historial de lanzamiento de versiones](reference-connect-version-history.md).
...
* Compatibilidad para sincronización de contraseñas de [Servicios de dominio de Azure AD](https://support.microsoft.com/account-billing/reset-your-work-or-school-password-using-security-info-23dde81f-08bb-4776-ba72-e6b72b9dda9e) .
