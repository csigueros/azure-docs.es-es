...
Puede actualizar el servidor de AAD Connect desde todas las versiones admitidas a las últimas versiones:
 ...
 - Si usa **Windows Server 2016 o posterior**, debe usar **Azure AD Connect V2.0**. Para descargar la versión más reciente de Azure AD Connect 2.0, utilice [este vínculo](https://www.microsoft.com/download/details.aspx?id=47594). [Las notas de la versión de la versión más reciente, V2.0](reference-connect-version-history.md#20280).
 - Si sigue usando una **versión anterior de Windows Server**, debe usar **Azure AD Connect V1.6**. Puede descargar la versión más reciente de Azure AD Connect V1 mediante [este vínculo](https://www.microsoft.com/download/details.aspx?id=103336). [Las notas de la versión de la versión más reciente, V1.6](reference-connect-version-history.md#16160).
...
>
> Esta versión no se admite en Windows Server 2016 ni posteriores. Esta versión incluye componentes de SQL Server 2012 y se va a retirar el 31 de agosto de 2022. Debe actualizar el sistema operativo del servidor y la versión de AADConnect antes de esa fecha.
>
...
### <a name="known-issues"></a>Problemas conocidos
 ...
 - En determinadas circunstancias, el instalador de esta versión mostrará un error que menciona que TLS 1.2 no está habilitado y detendrá la instalación. Esto se debe a un error en el código que comprueba la configuración del Registro para TLS 1.2. Lo vamos a corregir en un lanzamiento futuro. Los clientes que vean este problema deben seguir las instrucciones para habilitar TLS 1.2, que se pueden encontrar en el artículo sobre la [aplicación de TLS 1.2 a Azure AD Connect](reference-connect-tls-enforcement.md).
...
> [!NOTE]
> Esto es una versión de actualización de revisión de Azure AD Connect. Esta versión requiere Windows Server 2016 o posterior. Esta versión soluciona un problema que aparece en la versión 2.0.8.0 de Azure AD Connect, pero no en la versión 1.6.
...
> Para descargar la versión más reciente de Azure AD Connect 2.0, utilice [este vínculo](https://www.microsoft.com/download/details.aspx?id=47594).
...
> Esta versión aborda una vulnerabilidad como se documenta en [este CVE](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-36949). Para obtener más información sobre esta vulnerabilidad, consulte el CVE.
> Para descargar la versión más reciente de Azure AD Connect 1.6, utilice [este vínculo](https://www.microsoft.com/download/details.aspx?id=103336).
...
> Si ya ha instalado esta compilación, puede registrar manualmente los servicios de mantenimiento mediante el cmdlet, como se muestra en [este artículo](./how-to-connect-health-agent-install.md#manually-register-azure-ad-connect-health-for-sync).
...
### <a name="functional-changes"></a>Cambios funcionales
 ...
 - Se han actualizado las reglas de sincronización para admitir Reescritura de grupos v2.
   -Si se clona la regla "In from AAD - Group SOAInAAD" y se actualiza AADConnect.
 ...
 - Se ha actualizado el agente de AADConnectHealth a la versión 3.1.83.0.
 ...
 - Se ha quitado la columna Explicit (Explícito) de la página de búsqueda de CS de la interfaz de usuario de sincronización anterior.
 ...
 - Se han agregado dos cmdlets para leer la versión de AWS API.
...
### <a name="bug-fixes"></a>Corrección de errores
 ...
 - Corrección de la prioridad de la regla de sincronización predeterminada de duplicados al importar.
 ...
 - Se ha modificado la importación y exportación de directivas para que se genere un error si la regla personalizada tiene precedencia de duplicados.
