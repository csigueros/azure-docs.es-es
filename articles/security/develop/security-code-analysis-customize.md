...
Para obtener recursos adicionales para la tarea del analizador basado en Roslyn, consulte los [analizadores basados en Roslyn](/dotnet/standard/analyzers/api-analyzer) en Microsoft Docs.
