...
1. Seleccione **Data Map** (Mapa de datos) en el panel de navegación izquierdo y seleccione **Register** (Registro). Después, seleccione **Azure Blob Storage** y **Continue** (Continuar).
