...
> [!NOTE]
> No se admite la unidad de red asignada al cargar datos desde un recurso compartido de archivos de red. En su lugar, utilice la ruta de acceso real, por ejemplo ` \\server\share`.
