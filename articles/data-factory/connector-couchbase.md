---
title: Copia de datos de Couchbase (versión preliminar)
description: Obtenga información sobre cómo copiar datos de Couchbase en almacenes de datos receptores compatibles a través de una actividad de copia en una canalización de Azure Data Factory o Synapse Analytics.
...
En este artículo se describe el uso de la actividad de copia en una canalización de Azure Data Factory o Synapse Analytics para copiar datos de Couchbase. El documento se basa en el artículo de [introducción a la actividad de copia](copy-activity-overview.md) que describe información general de la actividad de copia.
...
## <a name="create-a-linked-service-to-couchbase-using-ui"></a>Creación de un servicio vinculado a Couchbase mediante la interfaz de usuario

Siga estos pasos para crear un servicio vinculado a Couchbase en la interfaz de usuario de Azure Portal.
...
2. Busque Couchbase y seleccione el conector de Couchbase.

   :::image type="content" source="media/connector-couchbase/couchbase-connector.png" alt-text="Captura de pantalla del conector de Couchbase.":::    


1. Configure los detalles del servicio, pruebe la conexión y cree el nuevo servicio vinculado.

   :::image type="content" source="media/connector-couchbase/configure-couchbase-linked-service.png" alt-text="Captura de pantalla de la configuración del servicio vinculado en Couchbase.":::
...
| Propiedad | Descripción | Obligatorio |
|:--- |:--- |:--- |
| type | La propiedad type del conjunto de datos se debe establecer en **CouchbaseTable**. | Sí |
