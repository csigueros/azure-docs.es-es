...
description: 'Aprenda a crear una canalización predictiva mediante Machine Learning Studio (clásico): actividad de ejecución por lotes en Azure Data Factory o Synapse Analytics.'
...
ms.locfileid: "131020148"
---
# <a name="create-a-predictive-pipeline-using-machine-learning-studio-classic-with-azure-data-factory-or-synapse-analytics"></a>Creación de una canalización predictiva con Machine Learning Studio (clásico) con Azure Data Factory o Synapse Analytics
...
### <a name="using-machine-learning-studio-classic-with-azure-data-factory-or-synapse-analytics"></a>Uso de Machine Learning Studio (clásico) con Azure Data Factory o Synapse Analytics
Azure Data Factory y Synapse Analytics permiten crear fácilmente canalizaciones que usan un servicio web de [Machine Learning Studio (clásico)](https://azure.microsoft.com/documentation/services/machine-learning) publicado para realizar análisis predictivos. Con la **actividad de ejecución por lotes** en una canalización, puede invocar un servicio web de Machine Learning Studio (clásico) para realizar predicciones sobre los datos del lote.
...
Se crea un servicio vinculado de **Machine Learning Studio (clásico)** para vincular un servicio web de Machine Learning Studio (clásico). El servicio vinculado lo usan la actividad de ejecución por lotes de Machine Learning Studio (clásico) y la [actividad de actualización de recurso](update-machine-learning-models.md).
