---
title: 'Conexión a Azure Virtual Desktop desde Android: Azure'
description: Procedimiento para conectarse a Azure Virtual Desktop mediante el cliente Android.
author: Heidilohr
ms.topic: how-to
ms.date: 03/25/2020
ms.author: helohr
...
ms.locfileid: "111757938"
---
# <a name="connect-to-azure-virtual-desktop-with-the-android-client"></a>Conexión a Azure Virtual Desktop con el cliente Android

> Se aplica a: Android 4.1 y posteriores, Chromebooks con ChromeOS 53 y posteriores.

>[!IMPORTANT]
>Este contenido se aplica a Azure Virtual Desktop con objetos de Azure Resource Manager. Si usa Azure Virtual Desktop (clásico) sin objetos de Azure Resource Manager, consulte [este artículo](./virtual-desktop-fall-2019/connect-android-2019.md).
