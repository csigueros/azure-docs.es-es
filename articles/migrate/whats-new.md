...
- Compatibilidad con [discos Ultra](https://docs.microsoft.com/azure/virtual-machines/disks-types#ultra-disk) de Azure en la recomendación de evaluación de máquinas virtuales de Azure.
