---
title: Versiones retiradas de Azure HDInsight
description: Obtenga información sobre las versiones retiradas de Azure HDInsight.
...
ms.locfileid: "121748464"
---
# <a name="retired-hdinsight-versions"></a>Versiones de HDInsight retiradas

En este artículo obtendrá información sobre las versiones retiradas de HDInsight.

## <a name="retired-version-list"></a>Lista de versiones retiradas

En la tabla siguiente se enumeran las versiones retiradas de HDInsight.
