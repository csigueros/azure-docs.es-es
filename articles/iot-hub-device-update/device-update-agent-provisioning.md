...
1. Siga las instrucciones para [aprovisionar manualmente un único dispositivo IoT Edge en Linux](../iot-edge/how-to-provision-single-device-linux-symmetric.md?preserve-view=true&view=iotedge-2020-11).
