...
- **Permitido por las directivas de Azure:** si usa [Azure Policy](../../governance/policy/overview.md) para denegar la creación o modificación de los recursos del ámbito que incluye una subred o una red virtual de SQL Managed Instance, dichas directivas no deben impedir que la instancia administrada administre sus recursos internos. Los siguientes recursos deben excluirse de los efectos de denegación para permitir el funcionamiento normal:
  - Recursos de tipo Microsoft.Network/serviceEndpointPolicies, cuando el nombre del recurso comienza por \_e41f87a2\_.
...
- **Bloqueos en la red virtual:** los [bloqueos](../../azure-resource-manager/management/lock-resources.md) en la red virtual de la subred dedicada, su grupo de recursos principal, o suscripción, pueden interferir ocasionalmente con las operaciones de administración y mantenimiento de SQL Managed Instance. Al usar estos bloqueos, debe tener especial cuidado.
