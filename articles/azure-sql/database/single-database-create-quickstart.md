...
1. Ejecute el comando `az sql up`. Si no se usa ningún parámetro necesario, como `--server-name`, el recurso se crea con un nombre aleatorio e información de inicio de sesión asignados.
