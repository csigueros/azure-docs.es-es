...
| ---| --- |
| [Autenticación solo de Azure AD](authentication-azure-ad-only-authentication.md) | Es posible configurar su instancia de Azure SQL Database permitir la autenticación solo desde Azure Active Directory. | 
...
| [Transacciones elásticas](elastic-transactions-overview.md) | Las transacciones elásticas se pueden distribuir entre bases de datos en la nube en Azure SQL Database y Azure SQL Managed Instance. |
