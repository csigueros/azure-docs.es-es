...
1. En la página Ofertas de Marketplace, seleccione **+ Nueva oferta** > **Dynamics 365 for Business Central**.

    [ ![Muestra el botón "Nueva oferta". El tipo de oferta Dynamics 365 Business Central está resaltado.](media/dynamics-365/new-offer-dynamics-365-business-central-workspaces.png) ](media/dynamics-365/new-offer-dynamics-365-business-central-workspaces.png#lightbox)
...
1. En la página de información general, seleccione **+ Nueva oferta** > **Dynamics 365 for Business Central**.
...
En el cuadro de diálogo que aparece, especifique un **Id. de oferta**. Se trata de un identificador único para cada oferta de su cuenta.
