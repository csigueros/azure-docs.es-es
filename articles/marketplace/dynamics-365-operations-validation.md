...
> [!NOTE]
> Si la solución o la oferta que va a crear es solo un conector, realice una demostración del conector que funciona durante la llamada o use una de las opciones de carga de vídeo que se enumeran a continuación.  
...
3. Realice la carga en el Centro de partners.
    ...
    [ ![Muestra un archivo ZIP cargado en la página de contenido adicional.](./media//dynamics-365-operations/supplemental-content-workspaces.png) ](./media//dynamics-365-operations/supplemental-content-workspaces.png#lightbox)
...
2. Realice las siguientes capturas de pantalla del entorno [LCS](https://lcs.dynamics.com/) que coincida con la oferta o solución que desee publicar. Tienen que ser suficientemente claras para que el equipo de certificación pueda leer el texto. Guárdelas como archivos JPG.
