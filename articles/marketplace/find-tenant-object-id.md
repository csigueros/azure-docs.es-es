...
description: Búsqueda del identificador de inquilino, el identificador de objeto y los detalles de la asociación de asociados de un identificador de suscripción en Azure Marketplace.
