...
> [!NOTE]
> Si tiene preguntas sobre este artículo o comentarios sobre mejoras, póngase en contacto con el [soporte técnico del Centro de partners](https://go.microsoft.com/fwlink/?linkid=2165533).
...
|2|Tipo de blob no válido|La máquina virtual no se pudo aprovisionar porque el bloque utilizado es de tipo bloque en lugar de tipo página.|Vuelva a crear la imagen como tipo página y envíe la solicitud.|
...
> - [Documentación de Windows](../virtual-machines/generalize.md#windows)
...
- Si tiene preguntas o comentarios sobre mejoras, póngase en contacto con el [equipo de soporte técnico del Centro de partners](https://go.microsoft.com/fwlink/?linkid=2165533).
