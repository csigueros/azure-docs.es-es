...
Para registrarse como anunciante de marketplace comercial, vaya a [Centro de partners](https://go.microsoft.com/fwlink/?linkid=2165614).
...
Para ponerse en contacto con el equipo de soporte técnico al editor en el marketplace, puede [Enviar incidencias de soporte técnico](https://go.microsoft.com/fwlink/?linkid=2165533) desde el Centro de partners.
...
> [!NOTE]
> No se conceden reembolsos por el uso medido de Virtual Machines, la facturación medida de aplicaciones SaaS y de Azure, u otras instancias de consumo de productos (pago por uso, etc.).  Si un proveedor recibe un reembolso, se reflejará en los [informes de pagos](/partner-center/payout-statement?context=/azure/marketplace/context/context) del Centro de partners.
