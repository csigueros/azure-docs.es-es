...
> [!IMPORTANT]  
> El 31 de agosto de 2024 se retirará el SDK de Java v2.x asincrónico de Azure Cosmos DB; el SDK y todas las aplicaciones que lo usan **seguirán funcionando**; Azure Cosmos DB simplemente dejará de proporcionar mantenimiento y soporte técnico para este SDK.
