...
En la guía siguiente se describe cómo usar PowerShell para crear scripts y automatizar la administración de los recursos de API de Azure Cosmos DB Core (SQL), incluida la cuenta, la base de datos, el contenedor y el rendimiento de Cosmos. Para obtener cmdlets de PowerShell para otras API, consulte [Ejemplos de PowerShell para Cassandra](../cassandra/powershell-samples.md), [Ejemplos de PowerShell para MongoDB API](../mongodb/powershell-samples.md), [Ejemplos de PowerShell para Gremlin](../graph/powershell-samples.md) y [Ejemplos de PowerShell para Table](../table/powershell-samples.md).
