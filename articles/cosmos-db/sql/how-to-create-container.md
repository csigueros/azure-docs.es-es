...
En este artículo se explican las distintas formas de crear un contenedor en la API de SQL de Azure Cosmos DB. Si usa una API diferente, consulte los artículos [API para MongoDB](../mongodb/how-to-create-container-mongodb.md), [Cassandra API](../cassandra/how-to-create-container-cassandra.md), [Gremlin API](../graph/how-to-create-container-gremlin.md) y [Table API](../table/how-to-create-container.md) para crear el contenedor.
