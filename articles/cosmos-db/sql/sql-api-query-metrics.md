...
Para información sobre las rutas de indexación, las clases y los modos y cómo afectan a la ejecución de consultas, consulte [Configuración de la directiva de indexación](../index-policy.md). De manera predeterminada, la directiva de indexación usa índices de rango para las cadenas, lo cual resulta eficaz en el caso de las consultas de igualdad. Si tiene consultas de intervalo para las cadenas, se recomienda especificar el tipo de índice de intervalo para todas las cadenas. 
...
| `retrievedDocumentCount` | recuento | Número total de documentos recuperados  | 
| `retrievedDocumentSize` | bytes | Tamaño total de los documentos recuperados, en bytes  | 
| `outputDocumentCount` | recuento | Número de documentos de salida | 
| `writeOutputTimeInMs` | milisegundos | Tiempo dedicado a escribir el resultado, en milisegundos. | 
