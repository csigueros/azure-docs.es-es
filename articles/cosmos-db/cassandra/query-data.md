...
* Este artículo pertenece a un tutorial de varias partes. Antes de empezar, asegúrese de completar los pasos anteriores para crear la cuenta de Cassandra API, el espacio de claves, la tabla y [cargar datos de ejemplo en la tabla](load-data-table.md). 
...
> [Migrar datos a la cuenta de Cassandra API](migrate-data.md)
