...
En este artículo se explican las distintas formas de crear un contenedor en Gremlin API de Azure Cosmos DB. Si usa una API diferente, consulte los artículos [API para MongoDB](../mongodb/how-to-create-container-mongodb.md), [Cassandra API](../cassandra/how-to-create-container-cassandra.md), [Table API](../table/how-to-create-container.md) y [API de SQL](../how-to-create-container.md) para crear el contenedor.
