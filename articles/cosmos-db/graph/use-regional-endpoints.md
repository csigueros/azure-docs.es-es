...
:::image type="content" source="./media/use-regional-endpoints/get-end-point-portal.png " alt-text="Recuperación de regiones de la cuenta de grafos de Cosmos DB desde el portal":::
