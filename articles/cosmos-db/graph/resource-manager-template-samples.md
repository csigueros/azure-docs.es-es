...
Este artículo solo tiene ejemplos de cuentas de API de Gremlin; para buscar ejemplos de otras cuentas de tipo de API, vea los artículos sobre el uso de plantillas de Azure Resource Manager con la API de Azure Cosmos DB para [Cassandra](../cassandra/templates-samples.md), [SQL](../templates-samples-sql.md), [MongoDB](../mongodb/resource-manager-template-samples.md) y [Table](../table/resource-manager-templates.md).
