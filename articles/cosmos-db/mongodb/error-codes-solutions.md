...
>[!Note]
> Azure Cosmos DB no hospeda el motor de MongoDB. Proporciona una implementación del [protocolo de conexión 4.0](feature-support-40.md) y [3.6](feature-support-36.md) de MongoDB y compatibilidad heredada con la [versión 3.2 del protocolo de conexión](feature-support-32.md). Por lo tanto, algunos de estos errores solo se encuentran en la API de Azure Cosmos DB para MongoDB.
