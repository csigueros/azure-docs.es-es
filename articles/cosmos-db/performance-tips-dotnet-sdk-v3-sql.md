...
## <a name="sdk-usage"></a><a id="sdk-usage"></a> Uso del SDK
...
* No use ToList() en `Container.GetItemLinqQueryable<T>()` si se usan llamadas de bloqueo para purgar la consulta de manera sincrónica. Use [ToFeedIterator()](https://github.com/Azure/azure-cosmos-dotnet-v3/blob/e2029f2f4854c0e4decd399c35e69ef799db9f35/Microsoft.Azure.Cosmos/src/Resource/Container/Container.cs#L1143) para purgar la consulta de manera asincrónica.
...
## <a name="indexing-policy"></a><a id="indexing-policy"></a> Directiva de indexación
