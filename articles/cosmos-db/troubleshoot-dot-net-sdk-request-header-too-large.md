...
> [!IMPORTANT]
> Actualice al menos a .NET [v3.20.1](https://github.com/Azure/azure-cosmos-dotnet-v3/blob/master/changelog.md) o [v2.15.0](https://github.com/Azure/azure-cosmos-dotnet-v2/blob/master/changelog.md). Estas versiones secundarias contienen optimizaciones para reducir el tamaño del token de sesión para evitar que el encabezado crezca y alcance el límite de tamaño.
