...
* Cuando se ha superado el límite de API, el código de respuesta HTTP es **429**.  Por ejemplo:
   ...
   Este código de respuesta puede proceder de una limitación o una condición temporal. Consulte más información sobre el [código de error HTTP 429 de Azure Resource Manager](../azure-resource-manager/management/request-limits-and-throttling.md#error-code).
