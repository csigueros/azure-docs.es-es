---
title: Conjunto de datos sobre diabetes
titleSuffix: Azure Open Datasets
description: Aprenda a usar el conjunto de datos sobre diabetes en Azure Open Datasets.
...
ms.locfileid: "112039171"
---
# <a name="diabetes-dataset"></a>Conjunto de datos sobre diabetes

El conjunto de datos de Diabetes tiene 442 muestras con 10 características, por lo que es ideal para comenzar con algoritmos de aprendizaje automático. Es uno de los [conjuntos de datos de Scikit Learn Toy](https://scikit-learn.org/stable/datasets/toy_dataset.html#diabetes-dataset) más conocidos.

[Descripción del conjunto de datos original](https://www4.stat.ncsu.edu/~boos/var.select/diabetes.html) 
| [Archivo de datos original](https://www4.stat.ncsu.edu/~boos/var.select/diabetes.tab.txt)
