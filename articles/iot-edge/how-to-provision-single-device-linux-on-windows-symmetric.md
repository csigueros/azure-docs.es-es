---
title: Creación y aprovisionamiento de un dispositivo IoT Edge para Linux en Windows con claves simétricas - Azure IoT Edge | Microsoft Docs
description: Creación y aprovisionamiento de un dispositivo IoT Edge único para Linux en Windows en IoT Hub mediante el aprovisionamiento manual con claves simétricas
author: kgremban
...
ms.locfileid: "131853403"
---
# <a name="create-and-provision-an-iot-edge-for-linux-on-windows-device-using-symmetric-keys"></a>Creación y aprovisionamiento de un dispositivo IoT Edge para Linux en Windows con claves simétricas
...
En este artículo se describe el uso de claves simétricas como método de autenticación. Si desea usar certificados X.509, consulte [Creación y aprovisionamiento de un dispositivo IoT Edge para Linux en Windows con certificados X.509](how-to-provision-single-device-linux-on-windows-x509.md).
...
Para aprovisionar el dispositivo mediante claves simétricas, necesitará la **cadena de conexión** del dispositivo.
...
1. Seleccione **Provisioning with the selected method** (Aprovisionar con el método seleccionado).
   ...
   ![Elija Aprovisionar con el método seleccionado después de pegar la cadena de conexión del dispositivo.](./media/how-to-provision-single-device-linux-on-windows-symmetric/provisioning-with-selected-method-connection-string.png)
