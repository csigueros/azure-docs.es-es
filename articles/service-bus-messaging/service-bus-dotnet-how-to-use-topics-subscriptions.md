...
ms.locfileid: "129807528"
---
# <a name="get-started-with-azure-service-bus-topics-and-subscriptions"></a>Introducción a los temas y las suscripciones de Azure Service Bus
...
1. En la ventana **Consola del Administrador de paquetes**, confirme que **SubscriptionReceiver** esté seleccionado para el **Proyecto predeterminado**. Si no es así, use la lista desplegable para seleccionar **SubscriptionReceiver**.
    ...
    :::image type="content" source="./media/service-bus-dotnet-how-to-use-topics-subscriptions/select-subscription-receiver-project.png" alt-text="Imagen que muestra la selección del proyecto SubscriptionReceiver en la ventana de la consola del administrador de paquetes." lightbox="./media/service-bus-dotnet-how-to-use-topics-subscriptions/select-subscription-receiver-project.png":::    
...
1. Reemplace el código del archivo **Program.cs** por el código siguiente. Estos son los pasos importantes del código:
    ...
    ```
1. Este es el aspecto que debería tener `Program.cs`:  
