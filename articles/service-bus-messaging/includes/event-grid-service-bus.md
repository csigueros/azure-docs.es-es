...
### <a name="active-messages-available-with-no-listeners"></a>Mensajes activos disponibles sin clientes de escucha
...
#### <a name="deadletter-messages-available-with-no-listeners"></a>Mensajes fallidos disponibles sin clientes de escucha
