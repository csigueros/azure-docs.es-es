...
Para establecer el emparejamiento BGP desde el servidor de rutas a la aplicación virtual de red, use [New-AzRouteServerPeer](/powershell/module/az.network/new-azrouteserverpeer):
