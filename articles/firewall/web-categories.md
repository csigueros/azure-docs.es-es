...
|Violencia   | Sitios que contienen imágenes o textos que describen o alientan el daño físico contra personas, animales o instituciones. Sitios de naturaleza desagradable.         |
|Armas      |Sitios en los que se describen, venden o analizan armas, incluidas las de carácter deportivo.         |


## <a name="high-bandwidth"></a>Ancho de banda elevado

|Category  |Descripción  |
|---------|---------|
|Uso compartido de imágenes    |   Sitios en los que se hospedan fotografías e imágenes digitales, álbumes de fotos en línea y se intercambian fotos digitales.       |
|De punto a punto    |  Sitios que permiten el intercambio directo de archivos entre usuarios sin depender de un servidor central.        |
|Streaming multimedia y descargas    |  Sitios que proporcionan contenido en streaming, como radio por Internet, TV por Internet o MP3, y sitios de descarga de elementos multimedia en directo o archivados. Incluye sitios de seguidores o sitios oficiales administrados por músicos, grupos o sellos discográficos.        |
|Sitios de descarga      | Sitios que contienen software descargable, ya sea shareware, software gratuito o de pago.         |
|Entretenimiento     |  Sitios que contienen guías de programación de televisión, películas, música y vídeo (incluido vídeo bajo demanda), sitios de famosos y noticias de entretenimiento.        |
|    |         |

## <a name="business-use"></a>Uso empresarial

|Category  |Descripción  |
|---------|---------|
|Business    |   Sitios en los que se proporciona información relacionada con la empresa, como sitios web corporativos. Información, servicios o productos que ayudan a empresas de todos los tamaños a realizar sus actividades comerciales diarias.       |
|Informática y tecnología   |Sitios que contienen información como revisiones de productos, discusiones y noticias sobre equipos, software, hardware, periféricos y servicios informáticos.          |
|Education   |  Sitios patrocinados por instituciones educativas y centros de todo tipo, incluidos los de educación a distancia. Incluye materiales educativos y de referencia generales, como diccionarios, enciclopedias, cursos en línea, ayuda para la enseñanza y guías de discusión.       |
|Finance    | Sitios relacionados con la banca, las finanzas, pagos o inversiones, incluidos bancos, corredores de bolsa, operaciones bursátiles en línea, cotizaciones bursátiles, administración de fondos, compañías de seguros, uniones de crédito, compañías de tarjetas de crédito, entre otros.         |
|Foros y grupos de noticias     | Sitios para compartir información en forma de grupos de noticias, foros, paneles de anuncios. No incluye blogs personales.         |
|Gobierno      |  Sitios administrados por organizaciones, departamentos o agencias gubernamentales o militares, incluidos departamentos de policía o bomberos, oficinas de aduanas, servicios de emergencia, defensa civil y organizaciones antiterroristas.        |
|Salud y medicina      |   Sitios que contienen información relacionada con la salud, los servicios sanitarios y el bienestar, incluida información sobre equipamientos médicos, hospitales, farmacias, enfermería, medicina, tratamientos, medicamentos con receta, etc.       |
|Seguridad de la información     |   Sitios que proporcionan información legítima sobre la protección de datos, incluidas las vulnerabilidades recién detectadas y cómo bloquearlas.       |
|Búsqueda de empleo    |  Sitios que contienen ofertas de trabajo, información profesional, asistencia con búsquedas de trabajo (por ejemplo, redacción de currículos, sugerencias para entrevistas, etc.), agencias de empleo o cazatalentos.        |
|Noticias  |    Sitios sobre noticias y eventos actuales, como periódicos, agencias de noticias, servicios de noticias personalizados, sitios de difusión y revistas.      |
|Organizaciones sin ánimo de lucro y ONG     |   Sitios dedicados a organizaciones, comunidades, sindicatos y organizaciones sin ánimo de lucro. Muchos de estos grupos existen con fines educativos o benéficos.       |
|Sitios personales     |    Sitios sobre personas concretas (u hospedados por ellas) incluidos los que se hospedan en sitios comerciales como Blogger, AOL, etc.      |
|Direcciones IP privadas      |  Sitios que son direcciones IP privadas, de acuerdo a la definición de RFC 1918, es decir, hosts que no necesitan acceder a hosts de otras empresas (o que necesitan acceso limitado) y cuya dirección IP puede ser ambigua entre empresas, pero que están bien definidas dentro de una empresa concreta.        |
|Redes profesionales   | Sitios que fomentan las redes profesionales para comunidades en línea.   |
|Motores de búsqueda y portales   |Sitios que permiten la búsqueda en la web, grupos de noticias, imágenes, directorios y otro contenido en línea. Incluye sitios de directorios y portales, como páginas blancas o amarillas.    |
|Traductores     |   Sitios que traducen páginas web o frases de un idioma a otro. Estos sitios omiten el servidor proxy, lo que implica el riesgo de que se pueda acceder a contenido no autorizado, como sucede al usar un anonimizador.       |
|Repositorio de archivos     |  Páginas web que incluyen colecciones de shareware, software gratuito, de código abierto y otras descargas de software.        |
|Correo electrónico basado en web     | Sitios que permiten a los usuarios enviar y recibir correo electrónico por medio de una cuenta de correo electrónico accesible desde la web.         |
|     |         |
