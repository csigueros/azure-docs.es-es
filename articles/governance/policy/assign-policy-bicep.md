...
- Versión `0.3` de Bicep o posterior instalada. Si aún no tiene la CLI de Bicep o necesita actualizarla, consulte [Instalación de Bicep (versión preliminar)](../../azure-resource-manager/bicep/install.md).
