---
title: Inicio rápido de conexión de NXP MIMXRT1050-EVKB a Azure IoT Central
description: Use software insertado de Azure RTOS para conectar un dispositivo NXP MIMXRT1050-EVKB a Azure IoT y enviar telemetría.
author: timlt
ms.author: timlt
...
[![Examinar el código](media/common/browse-code.svg)](https://github.com/azure-rtos/getting-started/tree/master/NXP/MIMXRT1050-EVKB/)

En este inicio rápido, usará Azure RTOS para conectar un kit de evaluación NXP MIMXRT1050-EVKB (en adelante, NXP EVK) a Azure IoT.
...
Para conectar NXP EVK a Azure, modificará un archivo de configuración de las opciones de Wi-Fi y Azure IoT, recompilará la imagen y la guardará en la memoria flash en el dispositivo.
...
1. En EVK NXP, busque el botón **Reset**, el puerto microUSB y el puerto Ethernet. Usará estos componentes en los pasos siguientes. Los tres están resaltados en la siguiente imagen:
    ...
    :::image type="content" source="media/quickstart-devkit-nxp-mimxrt1050-evkb/nxp-1050-evkb-board.png" alt-text="Búsqueda de componentes clave en la placa de NXP EVK":::
...
1. Copia del archivo binario *mimxrt1050_azure_iot.bin*
1. En el Explorador de archivos, busque el dispositivo NXP EVK conectado al equipo. El dispositivo aparece como una unidad en el sistema con la etiqueta de unidad **RT1050-EVK**.
...
1. Confirme que **Plantilla de dispositivo** se ha actualizado a **Guía de introducción**.
    ...
    :::image type="content" source="media/quickstart-devkit-nxp-mimxrt1050-evkb/iot-central-device-view-status.png" alt-text="Captura de pantalla del estado del dispositivo en IoT Central":::
...
1. La temperatura se mide desde la oblea de MCU.
    ...
    :::image type="content" source="media/quickstart-devkit-nxp-mimxrt1050-evkb/iot-central-device-telemetry.png" alt-text="Captura de pantalla de la telemetría del dispositivo en IoT Central":::
...
1. En la lista desplegable **Estado**, seleccione **Verdadero** y, luego, elija **Ejecutar**.  No habrá ningún cambio en el dispositivo, ya que no hay un LED disponible que alternar. Puede ver la salida en Termite para supervisar el estado de los métodos.

    :::image type="content" source="media/quickstart-devkit-nxp-mimxrt1050-evkb/iot-central-invoke-method.png" alt-text="Captura de pantalla de la llamada a un método directo en un dispositivo en IoT Central":::
...
:::image type="content" source="media/quickstart-devkit-nxp-mimxrt1050-evkb/iot-central-device-about.png" alt-text="Captura de pantalla de la información del dispositivo en IoT Central":::
