...
### <a name="windows-services-data"></a>Datos de servicios de Windows
...
![Control deslizante de servicios de Windows](./media/overview/windowservices.png)
