...
* [Implementar una máquina virtual con una dirección IP pública estática mediante el portal de Azure](../../virtual-network/virtual-network-deploy-static-pip-arm-portal.md)
