...
+ Proyectos de etiquetado de datos para crear, administrar y supervisar proyectos para etiquetar [imágenes](how-to-create-image-labeling-projects.md) o [texto](how-to-create-text-labeling-projects.md).
