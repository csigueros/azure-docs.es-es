...
### <a name="err_1102-no-more-role-assignments"></a>ERR_1102: No se admiten más asignaciones de roles

Elimine asignaciones de roles que no utilice en esta suscripción. Puede consultar todas las asignaciones de roles en Azure Portal, en el menú Control de acceso.

### <a name="err_1103-endpoint-quota-reached"></a>ERR_1103: Se alcanzó la cuota de puntos de conexión

Elimine algunos puntos de conexión que no utilice de esta suscripción.
...
### <a name="err_2102-resources-requests-invalid"></a>ERR_2102: Solicitudes de recursos no válidas
