...
Para crear por sí mismo una instancia de proceso, utilice el área de trabajo de Estudio de Azure Machine Learning y [cree una nueva instancia de proceso](how-to-create-manage-compute-instance.md?tabs=azure-studio#create) desde la sección **Proceso** o en la sección **Cuadernos** cuando esté listo para ejecutar uno de sus cuadernos.
