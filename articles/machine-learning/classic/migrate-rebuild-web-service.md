...
En este artículo, aprenderá a recompilar un servicio web de Studio (clásico) como **punto de conexión** en [Azure Machine Learning](../index.yml).
