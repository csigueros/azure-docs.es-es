...
* Hay varias maneras de usar la API de REST y acceder al servicio web. Vea [Consumo de un servicio web de Machine Learning Studio (clásico)](consume-web-services.md).
