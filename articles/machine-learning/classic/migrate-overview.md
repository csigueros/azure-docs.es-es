...
ms.locfileid: "112580537"
---
# <a name="migrate-to-azure-machine-learning"></a>Migración a Azure Machine Learning 

En este artículo, aprenderá a migrar recursos de Estudio de Machine Learning (clásico) a [Azure Machine Learning](../index.yml). En este momento, para migrar los recursos, debe recompilar manualmente los experimentos.
...
> * Paso 5: Limpiar los recursos de Estudio de ML (clásico)
