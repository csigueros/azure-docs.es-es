...
description: Obtenga información sobre qué es la privacidad diferencial y sobre cómo protegen la privacidad de datos los sistemas privados diferenciales.
...
A medida que aumenta la cantidad de datos que una organización recopila y usa para los análisis, también aumentan las preocupaciones relacionadas con la privacidad y la seguridad. Los análisis requieren datos. Normalmente, cuanto mayor número de datos se usan para entrenar los modelos de aprendizaje automático, más precisos son. Cuando se usa información personal para estos análisis, es especialmente importante que los datos permanezcan privados en todo el uso.

## <a name="how-differential-privacy-works"></a>Funcionamiento de la privacidad diferencial

La privacidad diferencial es un conjunto de sistemas y prácticas que ayudan a mantener los datos de los usuarios seguros y privados. En las soluciones de aprendizaje automático, puede ser necesaria la privacidad diferencial para el cumplimiento normativo.
...
Los valores de épsilon no son negativos. Los valores inferiores a 1 proporcionan una denegabilidad plausible completa. Cualquier valor superior a 1 se asocia a un riesgo mayor de exposición de los datos reales. A medida que implementa soluciones de aprendizaje automático con privacidad diferencial, quiere datos con valores de épsilon entre 0 y 1.
...
SmartNoise es un proyecto de código abierto que contiene componentes para compilar soluciones de aprendizaje automático con privacidad diferencial. SmartNoise se compone de los siguientes componentes de nivel superior:
...
Más información sobre la privacidad diferencial en el aprendizaje automático: 
