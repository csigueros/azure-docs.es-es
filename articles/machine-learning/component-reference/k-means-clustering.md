---
title: 'Agrupación en clústeres K-means: referencia del componente'
titleSuffix: Azure Machine Learning
description: Aprenda a usar el componente Agrupación en clústeres K-means en Azure Machine Learning para entrenar modelos de agrupación en clústeres.
...
ms.locfileid: "131565968"
---
# <a name="component-k-means-clustering"></a>Componente: Agrupación en clústeres K-means

En este artículo se describe cómo usar el componente *Agrupación en clústeres K-means* en el diseñador de Azure Machine Learning para crear un modelo de agrupación en clústeres K-means no entrenado. 
...
* Agregue este componente a la canalización.
...
Después de configurar los hiperparámetros de componente, conecte el modelo no entrenado al módulo [Entrenamiento del modelo de agrupación en clústeres](train-clustering-model.md). Dado que el algoritmo K-means es un método de aprendizaje no supervisado, la columna de etiqueta es opcional. 
...
-   El algoritmo se completó ejecutando el número de iteraciones especificado.  
 ...
 Tras completar la fase de entrenamiento, se usa el componente [Asignación de datos a clústeres](assign-data-to-clusters.md) para asignar nuevos casos a uno de los clústeres que encontró con el algoritmo K-means. Para realizar la asignación de clúster, calcule la distancia entre el nuevo caso y el centroide de cada clúster. Cada nuevo caso se asigna al clúster con el centroide más cercano.  

## <a name="configure-the-k-means-clustering-component"></a>Configuración del componente de agrupación en clústeres K-means
  
1.  Agregue el componente **Agrupación en clústeres K-means** a la canalización.  
...
10. Entrene el modelo.  
    ...
    -   Si establece **Crear modo de entrenador** en **Parámetro único**, agregue un conjunto de datos etiquetado y entrene el modelo con el componente [Entrenamiento del modelo de agrupación en clústeres](train-clustering-model.md).  
...
Si usó el componente [Entrenamiento del modelo de agrupación en clústeres](train-clustering-model.md):

1. Seleccione el componente **Entrenamiento del modelo de agrupación en clústeres** y abra el panel derecho.
...
1. Haga clic con el botón secundario en el componente **Entrenamiento del modelo de agrupación en clústeres**.
