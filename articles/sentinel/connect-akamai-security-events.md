...
1. Siga las instrucciones que aparecen en la pestaña **Instrucciones**, en **Configuración**:
    ...
    1. En **3. Validación de la conexión**. Para comprobar la ingesta de datos, copie el comando en la página de conectores y ejecútelo en el reenviador de registros. Vea [Validación de la conectividad CEF](troubleshooting-cef-syslog.md#validate-cef-connectivity) en la documentación de Azure Sentinel para obtener una explicación e instrucciones más detalladas.
