...
- [Referencia del esquema de normalización de autenticación de Microsoft Sentinel (versión preliminar pública)](authentication-normalization-schema.md)
