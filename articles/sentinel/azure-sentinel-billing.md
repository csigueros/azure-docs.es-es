...
## <a name="manage-and-monitor-azure-sentinel-costs"></a>Administración y supervisión de los costos de Azure Sentinel
...
Para más información, consulte [Crear presupuestos](#create-budgets) y [Otras formas de administrar y reducir los costos de Azure Sentinel](#other-ways-to-manage-and-reduce-azure-sentinel-costs).
