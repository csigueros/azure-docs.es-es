---
title: Procedimientos recomendados para la recopilación de datos en Microsoft Sentinel
description: Obtenga información sobre los procedimientos recomendados que se deben emplear al conectar orígenes de datos a Microsoft Sentinel.
services: sentinel
author: batamig
ms.author: bagol
ms.topic: conceptual
...
> [!TIP]
> Los conectores de datos personalizados permiten ingerir datos en Microsoft Sentinel desde orígenes de datos que la funcionalidad integrada no admite de momento, como el agente, Logstash o la API. Para obtener más información, vea [Recursos para crear conectores personalizados de Microsoft Sentinel](create-custom-connector.md).
>
...
> [!NOTE]
> Muchas de las soluciones que se enumeran a continuación requieren un conector de datos personalizado. Para obtener más información, vea [Recursos para crear conectores personalizados de Microsoft Sentinel](create-custom-connector.md).
>
...
|**Requiere etiquetado y enriquecimiento en la ingesta**     |Use Logstash para insertar un Id. de recurso. <br><br>Use una plantilla de ARM para insertar un Id. de recurso en máquinas locales. <br><br>Ingiera el Id. de recurso en áreas de trabajo independientes.        | Log Analytics no admite RBAC para tablas personalizadas. <br><br>Microsoft Sentinel no admite RBAC de nivel de fila. <br><br>**Sugerencia:** Es posible que quiera adoptar el diseño y la funcionalidad entre áreas de trabajo para Microsoft Sentinel.        |
...
|Dificultad/requisito  |Posibles soluciones  |Consideraciones  |
|---------|---------|---------|
|**Requiere filtrado de registros**     | Use Syslog-NG. <br><br>Use Rsyslog. <br><br>Use la configuración de FluentD para el agente. <br><br> Use el agente de Azure Monitor o Microsoft Monitoring Agent. <br><br> Use Logstash.  |  Es posible que algunas distribuciones de Linux no sean compatibles con el agente. <br> <br>El uso de Syslog o FluentD requiere conocimientos de desarrollo. <br><br>Para obtener más información, vea [Conexión a servidores Windows para recopilar eventos de seguridad](connect-windows-security-events.md) y [Recursos para crear conectores personalizados de Microsoft Sentinel](create-custom-connector.md).      |
...
|**Requiere varios inquilinos en una sola área de trabajo**     |  Personalice la recopilación de datos usando Azure LightHouse y una vista unificada de incidentes.|  La recopilación de datos personalizada tiene costes extras de ingesta.  <br><br>Para obtener más información, vea [Extensión de Microsoft Sentinel entre áreas de trabajo e inquilinos](extend-sentinel-across-workspaces-tenants.md).      |
| | | |
