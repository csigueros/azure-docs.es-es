...
1.  Elimine el archivo **metadata.db** del directorio **sapcon/[SID]** .
...
Este problema ocurre cuando el conector no arranca con PyRfc, o bien se muestran mensajes de error relacionados con ZIP.
...
1. Compruebe las transacciones **SM19** y **RASU_CONFIG**.
...
Aplique cifrado base64 al usuario y la contraseña. Para ello, puede usar herramientas de cifrado en línea, como https://www.base64encode.org/.

### <a name="incorrect-sap-abap-user-credentials-in-key-vault"></a>Credenciales de usuario de SAP ABAP incorrectas

Compruebe sus credenciales y corríjalas según sea necesario.

Aplique los valores correctos a los valores **ABAPUSER** y **ABAPPASS** en Azure Key Vault.
...
Si tiene incidencias inesperadas que no aparecen en este artículo, pruebe lo siguiente:
