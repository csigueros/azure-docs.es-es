...
1. Instale la [carga de trabajo "desarrollo para el escritorio con C++"](/cpp/build/vscpp-step-0-installation?view=vs-2019&preserve-view=true) para Visual Studio 2019. Visual Studio 2017 también se admite.
