...
![Diagrama de arquitectura para el escenario del tutorial.](./media/tutorial-connect-msi-sql-database/architecture.png)
...
> [!div class="nextstepaction"]
> [Tutorial: Conectar a servicios de Azure que no admiten identidades administradas (mediante Key Vault)](tutorial-connect-msi-key-vault.md)
