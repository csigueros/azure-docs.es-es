...
4. Elija el archivo que quiere analizar entre las opciones siguientes:
    ...
    * Una dirección URL para una imagen de un documento de identidad. Puede usar un [documento de identificación de ejemplo](https://raw.githubusercontent.com/Azure-Samples/cognitive-services-REST-api-samples/master/curl/form-recognizer/DriverLicense.png) para este inicio rápido.
