...
|--|--|--|--|
| Detalles del proyecto | Suscripción | Requerido | Seleccione la suscripción para la nueva cuenta de almacenamiento. |
| Detalles del proyecto | Resource group | Obligatorio | Cree un nuevo grupo de recursos para esta cuenta de almacenamiento o seleccione uno existente. Para obtener más información, vea el apartado [Grupos de recursos](../../azure-resource-manager/management/overview.md#resource-groups). |
