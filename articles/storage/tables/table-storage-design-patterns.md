...
![Gráfico de la entidad de empleado en la que una aplicación cliente puede usar una consulta puntual para recuperar una entidad de empleado individual mediante el nombre del departamento y el identificador del empleado (los valores PartitionKey y RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE06.png)
...
![Gráfico que muestra una entidad de empleado con diferentes valores de RowKey](media/storage-table-design-guide/storage-table-design-IMAGE07.png)
...
* No es necesario duplicar todas las propiedades de su entidad. Por ejemplo, si las consultas que realizan búsquedas en las entidades mediante la dirección de correo electrónico de **RowKey** nunca necesitan la edad del empleado, dichas entidades podrían tener la siguiente estructura:
   ...
   ![Gráfico de la entidad de empleado](media/storage-table-design-guide/storage-table-design-IMAGE08.png)
...
![Gráfico de la estructura de la entidad de empleado por la que, cuando se usa, una aplicación cliente puede usar una consulta puntual para recuperar una entidad de empleado individual mediante el nombre del departamento y el identificador del empleado (los valores PartitionKey y RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE09.png)
...
![Gráfico que muestra una entidad de empleado con índice principal y una entidad de empleado con índice secundario](media/storage-table-design-guide/storage-table-design-IMAGE10.png)
...
* No es necesario duplicar todas las propiedades de su entidad. Por ejemplo, si las consultas que realizan búsquedas en las entidades mediante la dirección de correo electrónico de **RowKey** nunca necesitan la edad del empleado, dichas entidades podrían tener la siguiente estructura:
   ...
   ![Gráfico que muestra una entidad de empleado con índice secundario](media/storage-table-design-guide/storage-table-design-IMAGE11.png)
...
![Diagrama de la solución para mantener la coherencia final](media/storage-table-design-guide/storage-table-design-IMAGE12.png)
...
![Gráfico de la estructura de la entidad de empleado en la que una aplicación cliente puede recuperar de forma eficiente una entidad de empleado individual mediante el nombre del departamento y el identificador del empleado (los valores PartitionKey y RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE13.png)
...
![Gráfico que muestra una entidad de empleado con una cadena que contiene una lista de identificadores de empleado con el mismo apellido.](media/storage-table-design-guide/storage-table-design-IMAGE14.png)
...
![Gráfico de una entidad de departamento y una entidad de empleado](media/storage-table-design-guide/storage-table-design-IMAGE16.png)
...
![gráfico de entidad de departamento combinada y sin normalizar](media/storage-table-design-guide/storage-table-design-IMAGE17.png)
...
![Gráfico de la estructura de la entidad de empleado que se debe usar para almacenar entidades de empleado en Table Storage.](media/storage-table-design-guide/storage-table-design-IMAGE18.png)
...
![Gráfico de la entidad de revisión de empleado](media/storage-table-design-guide/storage-table-design-IMAGE19.png)
...
![Gráfico de entidad de empleado con clave compuesta](media/storage-table-design-guide/storage-table-design-IMAGE20.png)
...
![Gráfico de entidad de intento de inicio de sesión](media/storage-table-design-guide/storage-table-design-IMAGE21.png)
...
![Gráfico de entidad de estadísticas de mensajes](media/storage-table-design-guide/storage-table-design-IMAGE22.png)
...
![Gráfico que muestra una entidad de estadísticas de mensajes con propiedades independientes](media/storage-table-design-guide/storage-table-design-IMAGE23.png)
...
![Gráfico que muestra la entidad de estadísticas de mensajes con Rowkey 01 y la entidad de estadísticas de mensajes con Rowkey 02](media/storage-table-design-guide/storage-table-design-IMAGE24.png)
...
![Gráfico que muestra una entidad de empleado con cadena para Photo que apunta a Blob Storage](media/storage-table-design-guide/storage-table-design-IMAGE25.png)
...
Si utiliza la biblioteca cliente de Table, puede controlar automáticamente los tokens de continuación cuando devuelve entidades de Table service. El siguiente ejemplo de código de C# que utiliza la biblioteca cliente de Table maneja automáticamente tokens de continuación si Table service los devuelve en una respuesta:  
...
Si utiliza la biblioteca cliente de Table, tiene tres opciones para trabajar con varios tipos de entidad.  
