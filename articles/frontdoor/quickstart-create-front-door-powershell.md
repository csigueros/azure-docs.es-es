...
:::image type="content" source="media/quickstart-create-front-door/environment-diagram.png" alt-text="Diagrama del entorno de Front Door con PowerShell." border="false":::
