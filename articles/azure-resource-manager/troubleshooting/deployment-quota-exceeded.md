...
Para información sobre cómo quitar el bloqueo o admitir las eliminaciones automáticas, consulte [Eliminaciones automáticas del historial de implementaciones](../templates/deployment-history-deletions.md).
