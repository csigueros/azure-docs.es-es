...
- Aprenda a usar Azure Sentinel en el [Inicio rápido: Introducción a Azure Sentinel](/azure/defender-for-iot/organizations/articles/sentinel/get-visibility.md).