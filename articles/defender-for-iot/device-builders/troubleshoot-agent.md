...
- Más información sobre la [solución basada en agente para creadores de dispositivos](architecture-agent-based.md) de Defender para IoT
- Habilite el [servicio](quickstart-onboard-iot-hub.md) Defender para IoT.
- Consulte las [preguntas más frecuentes](resources-agent-frequently-asked-questions.md) del servicio Defender para IoT.
