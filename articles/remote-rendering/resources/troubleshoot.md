...
El servicio de conversión puede encontrar errores al descargar archivos de Blob Storage debido a los límites de longitud de ruta de acceso impuestos por Windows y el servicio. Las rutas de acceso de archivo y los nombres de archivo de Blob Storage no deben superar los 178 caracteres. Por ejemplo, dado un `blobPrefix` de `models/Assets` que tiene 13 caracteres:
