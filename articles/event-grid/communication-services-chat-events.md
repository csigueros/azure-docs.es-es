---
title: 'Azure Communication Services: eventos de chat'
description: En este artículo se describe cómo utilizar Azure Communication Services como origen de eventos de Event Grid para eventos de chat.
ms.topic: conceptual
ms.date: 10/15/2021
ms.author: vikramdh
...
ms.locfileid: "130134277"
---
# <a name="azure-communication-services---chat-events"></a>Azure Communication Services: eventos de chat

En este artículo se proporcionan las propiedades y el esquema de los eventos de chat de los servicios de comunicación.  Para una introducción a los esquemas de eventos, consulte [Esquema de eventos de Azure Event Grid](event-schema.md).

## <a name="event-types"></a>Tipos de eventos

Azure Communication Services emite los siguientes tipos de evento de chat:
