...
Se recomienda que se familiarice con las transformaciones personalizadas leyendo [Cómo codificar con una transformación personalizada: REST](transform-custom-preset-rest-how-to.md).
...
[Generación de miniaturas con .NET](transform-generate-thumbnails-dotnet-how-to.md)