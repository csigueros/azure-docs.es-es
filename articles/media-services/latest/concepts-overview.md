...
|Análisis de contenido (Video Analyzer for Media)|Media Services v3 le permite extraer información detallada de los archivos de audio y vídeo con los valores preestablecidos. Para analizar el contenido con los valores preestablecidos de Media Services v3, debe crear **transformaciones** y **trabajos**.<br/><br/>Si quiere obtener información más detallada, use [Video Analyzer for Media](../../azure-video-analyzer/video-analyzer-for-media-docs/index.yml) directamente.|[Análisis de archivos de audio y vídeo](analyze-video-audio-files-concept.md)|
|Empaquetado y entrega|Cuando el contenido está codificado, puede sacar partido del **empaquetado dinámico**. En Media Services, un **punto de conexión de streaming** es el servicio de empaquetado dinámico que se utiliza para entregar contenido multimedia a los reproductores del cliente. Para que los vídeos en el recurso de salida estén disponibles para los clientes para reproducción, tiene que crear un **localizador de streaming** y, después, generar direcciones URL de streaming. <br/><br/>Al crear un objeto **StreamingLocator**, debe especificar el nombre del recurso y el nombre de la **directiva de streaming**. Las **directivas de streaming** permiten definir los protocolos de streaming y las opciones de cifrado (si hubiera) de los **localizadores de streaming**. El empaquetado dinámico se utiliza si se transmite el contenido en directo o a petición. <br/><br/>Puede usar los **manifiestos dinámicos** de Media Services para transmitir solo una copia específica o subclips del vídeo. Además, si tiene contenido precodificado, o que ya ha sido codificado mediante un codificador de terceros, puede transmitirlo con los servicios de origen de AMS. Para ver un ejemplo del uso de un archivo de origen precodificado, consulte el ejemplo: [Streaming de un archivo MP4 existente](https://github.com/Azure-Samples/media-services-v3-dotnet/tree/main/Streaming/StreamExistingMp4). |[Empaquetado dinámico](encode-dynamic-packaging-concept.md)<br/><br/>[Puntos de conexión de streaming](stream-streaming-endpoint-concept.md)<br/><br/>[Localizadores de streaming](stream-streaming-locators-concept.md)<br/><br/>[Directivas de streaming](stream-streaming-policy-concept.md)<br/><br/>[Manifiestos dinámicos](filters-dynamic-manifest-concept.md)<br/><br/>[Filtros](filters-concept.md)|
...
|Clientes de Player|Puede usar cualquier marco de trabajo para reproductores que admita el protocolo HLS o DASH de streaming. Hay muchos reproductores comerciales y de código abierto disponibles en el mercado (Shaka, Hls.js, Video.js, Theo Player, Bitmovin Player, etc.), así como compatibilidad integrada con streaming a nivel de sistema operativo y de explorador nativo para HLS y DASH.  También se puede usar Azure Media Player para reproducir contenido multimedia que se transmite por Media Services en una gran variedad de exploradores. Azure Media Player usa los estándares del sector, como HTML5, Media Source Extensions (MSE, extensiones de origen multimedia) y Encrypted Media Extensions (EME, extensiones multimedia cifradas) para proporcionar una experiencia de streaming adaptable. |[Información general sobre Azure Media Player](player-use-azure-media-player-how-to.md)|
