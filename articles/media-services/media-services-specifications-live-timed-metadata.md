...
| ID                 | cadena entrecomillada                 | Obligatorio                                  | Un identificador único para el evento. Si no se especifica el id. cuando se ingiere el mensaje, Azure Media Services generará un id. exclusivo.                                                                                                                                              |
...
| Identificador                      | Entero sin signo de 32 bits | Obligatorio      | Identifica la instancia del mensaje. Los mensajes con una semántica equivalente deben tener el mismo valor. Si no se especifica el id. cuando se ingiere el mensaje, Azure Media Services generará un id. exclusivo.                                                                                        |
