---
title: 'Ejemplo de script: configuración de la copia de seguridad para el servidor Windows local'
description: Obtenga información sobre cómo configurar Backup para un servidor Windows local.
ms.topic: sample
ms.date: 06/23/2021
...
ms.locfileid: "112560853"
---
# <a name="powershell-script-to-configure-backup-for-on-premises-windows-server"></a>Script de PowerShell para configurar Backup para un servidor Windows local

Este script le ayuda a configurar Backup para el servidor Windows local, desde la creación de un almacén hasta la configuración del agente y la directiva MARS.
