...
| --- | --- | --- | --- | --- | --- | --- |
| Backup | Creación de una directiva de copia de seguridad y configuración de la misma | Compatible <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#back-up-azure-vms). | Compatible <br><br> [Consulte los ejemplos](/azure/backup/quick-backup-vm-cli#enable-backup-for-an-azure-vm) | Compatible  <br><br>  [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-backupazurevms). | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-auto-enable-backup). | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/backup-rm-template-samples). |
| Backup | Copia de seguridad de discos selectiva | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/selective-disk-backup-restore#using-powershell) | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/selective-disk-backup-restore#using-azure-cli). | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-backupazurevms#excluding-disks-in-azure-vm-backup). | N/D | N/D |
| Backup | Ejecución de la copia de seguridad a petición | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/quick-backup-vm-powershell#start-a-backup-job). | Compatible:  <br><br> [Consulte los ejemplos](/azure/backup/quick-backup-vm-cli#start-a-backup-job). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-backupazurevms#trigger-an-on-demand-backup-for-a-protected-azure-vm). | N/D | N/D |
| Restauración | Restauración de discos en la región primaria | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#restore-an-azure-vm). | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/tutorial-restore-disk#restore-a-vm-disk). | Compatible  <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-restoreazurevms). | N/D | N/D |
| Restauración | Restauración entre regiones | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#restore-disks-to-a-secondary-region). | Compatible   <br><br> [Consulte los ejemplos](/cli/azure/backup/restore?view=azure-cli-latest#az_backup_restore_restore_disks&preserve-view=true). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-restoreazurevms#cross-region-restore). | N/D | N/D |
| Restauración | Restauración selectiva de discos | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#restore-selective-disks). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/selective-disk-backup-restore#restore-disks-with-azure-cli). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-restoreazurevms#restore-disks-selectively). | N/D | N/D |
| Restauración | Creación de una máquina virtual a partir de discos restaurados | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#using-managed-identity-to-restore-disks). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/tutorial-restore-disk#using-managed-identity-to-restore-disks). | Compatible   <br><br> [Consulte los ejemplos](/rest/api/backup/restores/trigger). | N/D | N/D |
| Restauración | Restauración de archivos | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#create-a-vm-from-restored-disks). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/tutorial-restore-disk#create-a-vm-from-the-restored-disk). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-restoreazurevms#restore-disks). | N/D | N/D |
| Administrar | Supervisión de trabajos | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#restore-files-from-an-azure-vm-backup). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/tutorial-restore-files). | N/D | N/D |
| Administrar | Modificación de la directiva de copia de seguridad | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#monitoring-a-backup-job). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/quick-backup-vm-cli#monitor-the-backup-job). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-managejobs#tracking-the-job). | N/D | N/D |
| Administrar | Detener la protección y conservar los datos de copia de seguridad | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#retain-data). | Compatible   <br><br> [Consulte los ejemplos](/cli/azure/backup/protection?view=azure-cli-latest#az_backup_protection_disable&preserve-view=true). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-backupazurevms#stop-protection-but-retain-existing-data). | N/D | N/D |
| Administrar | Detener la protección y eliminar los datos de copia de seguridad | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#delete-backup-data). | Compatible   <br><br> [Consulte los ejemplos](/cli/azure/backup/protection?view=azure-cli-latest#az_backup_protection_disable&preserve-view=true). | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-backupazurevms#stop-protection-and-delete-data). | N/D | N/D |
| Administrar | Reanudar protección | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-vms-automation#resume-backup).    | Compatible    <br><br> [Consulte los ejemplos](/cli/azure/backup/protection?view=azure-cli-latest#az_backup_protection_resume&preserve-view=true). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-arm-userestapi-backupazurevms#undo-the-deletion) | N/D | N/D |

### <a name="sql-in-azure-vm"></a>SQL en Azure VM

| **Categoría** | **Operación** | **PowerShell** | **CLI** | **REST API** | **Azure Policy** | **Plantilla de ARM** |
| --- | --- | --- | --- | --- | --- | --- |
| Backup | Creación de una directiva de copia de seguridad y configuración de la misma | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#configure-a-backup-policy). | Compatible | Compatible | No se usa actualmente | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-rm-template-samples). |
| Backup | Habilitación de la protección automática | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#enable-autoprotection) | Compatible | Compatible | N/D | N/D |
| Backup | Ejecución de la copia de seguridad a petición | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#on-demand-backup). | Compatible | Compatible | N/D | N/D |
| Restauración | Restauración a un punto de recuperación completo o diferencial distinto | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#original-restore-with-distinct-recovery-point). | Compatible | Compatible | N/D | N/D |
| Restauración | Restauración a un punto en el tiempo | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#original-restore-with-log-point-in-time). | Compatible | Compatible | N/D | N/D |
| Restauración | Restauración entre regiones | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#alternate-workload-restore-to-a-vault-in-secondary-region). | Compatible | Compatible | N/D | N/D |
| Administrar | Supervisión de trabajos | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#track-azure-backup-jobs). | Compatible | Compatible | N/D | N/D |
| Administrar | Administración de las alertas de Azure Monitor (versión preliminar) | Compatible    <br><br> [Consulte los ejemplos](/azure/azure-monitor/powershell-samples). | Compatible | Compatible | N/D | N/D |
| Administrar | Administración de las métricas de Azure Monitor (versión preliminar) | Compatible    <br><br> [Consulte los ejemplos](/azure/azure-monitor/powershell-samples). | Compatible | Compatible | N/D | N/D |
| Administrar | Modificación de la directiva de copia de seguridad | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#change-policy-for-backup-items). | Compatible | Compatible | N/D | N/D |
| Administrar | Detener la protección y conservar los datos de copia de seguridad | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#retain-data). | Compatible | Compatible | N/D | N/D |
| Administrar | Detener la protección y eliminar los datos de copia de seguridad | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#delete-backup-data). | Compatible | Compatible | N/D | N/D |
| Administrar | Anulación del registro de la instancia | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#unregister-sql-vm). | Compatible | Compatible | N/D | N/D |
| Administrar | Volver a registrar la instancia | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-sql-automation#re-register-sql-vms). | Compatible | Compatible | N/D | N/D |

### <a name="sap-hana-in-azure-vm"></a>SAP HANA en la máquina virtual de Azure

| **Categoría** | **Operación** | **PowerShell** | **CLI** | **REST API** | **Azure Policy** | **Plantilla de ARM** |
| --- | --- | --- | --- | --- | --- | --- |
| Backup | Creación de una directiva de copia de seguridad y configuración de la misma | Actualmente no se admite | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/tutorial-sap-hana-backup-cli#register-and-protect-the-sap-hana-instance). | Compatible | Actualmente no se admite | N/D |
| Backup | Ejecución de la copia de seguridad a petición | Actualmente no se admite | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/tutorial-sap-hana-backup-cli#trigger-an-on-demand-backup). | Compatible | N/D | Compatible: ejemplos   <br><br> [Consulte los ejemplos](/azure/backup/backup-rm-template-samples). |
...
| **Categoría** | **Operación** | **PowerShell** | **CLI** | **REST API** | **Azure Policy** | **Plantilla de ARM** |
| --- | --- | --- | --- | --- | --- | --- |
| Backup | Creación de una directiva de copia de seguridad y configuración de la misma | Compatible   <br><br> [Consulte los ejemplos](/azure/backup/backup-managed-disks-ps). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-managed-disks-cli). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-dataprotection-use-rest-api-backup-disks). | Actualmente no se admite | Compatible |
| Backup | Ejecución de la copia de seguridad a petición | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-managed-disks-ps#run-an-on-demand-backup). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-managed-disks-cli#run-an-on-demand-backup). |  N/D | N/D |
| Restauración | Restauración en el nuevo disco | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/restore-managed-disks-ps). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/restore-managed-disks-cli). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-dataprotection-use-rest-api-restore-disks). | N/D | N/D |
| Administrar | Supervisión de trabajos | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/restore-managed-disks-ps#tracking-job). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/restore-managed-disks-cli#tracking-job). | Compatible    <br><br> [Consulte los ejemplos](/azure/backup/backup-azure-dataprotection-use-rest-api-restore-disks#track-jobs). | N/D | N/D |
| Administrar | Modificación de la directiva de copia de seguridad | Actualmente no se admite | Actualmente no se admite | Actualmente no se admite | N/D | N/D |
