...
Cree una cuenta de Automation con permisos de ejecución. Para obtener instrucciones, consulte [Creación de una cuenta de Azure Automation](../automation/quickstarts/create-account-portal.md).
