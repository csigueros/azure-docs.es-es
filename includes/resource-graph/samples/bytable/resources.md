...
### <a name="list-azure-arc-enabled-custom-locations-with-vmware-or-scvmm-enabled"></a>Enumeración de ubicaciones personalizadas habilitadas para Azure Arc con VMware o SCVMM habilitado
