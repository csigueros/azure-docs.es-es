...
En `pnp_thermostat_component.c`, la función `PnP_ThermostatComponent_SendTelemetry` muestra cómo el dispositivo envía la telemetría de temperatura de un componente a IoT Central:
