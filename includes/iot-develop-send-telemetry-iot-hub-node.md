...
1. Abra una nueva ventana de la consola. Esta consola se usará para instalar el SDK para Node.js y trabajar con el código de ejemplo de Node.js.
...
1. Establezca las siguientes variables de entorno para que el dispositivo simulado se pueda conectar a Azure IoT.
    ...
    **Bash (Linux o Windows)**
    ...
    ```
1. En la consola de Node, ejecute el código para el siguiente archivo de ejemplo. 
